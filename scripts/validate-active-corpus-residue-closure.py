...
POST_CLOSURE_ADR_AUTHORITY_PATHS = frozenset(
    {
        ...
        "docs/02.architecture/decisions/0025-pod-security-admission-per-namespace-adoption.md",
        "docs/02.architecture/decisions/0026-mutable-target-revision-retention.md",
    }
)
