#!/usr/bin/env python3
"""Compatibility CLI for registry-derived capability-tier validation."""
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Validate capability-tier references through the agent registry."
    )
    ...
    try:
        ...
        print(f"[PASS] agent model fitness{suffix}: {compat.format_counts(counts)}")
        return 0
