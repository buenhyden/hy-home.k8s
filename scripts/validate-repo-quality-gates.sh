...
for archive_candidate in \
    ...
    docs/98.archive/04.execution/plans/2026-07-17-archive-record-and-workspace-boundary.md \
    ...
    docs/98.archive/04.execution/tasks/2026-07-16-document-schema-and-lifecycle-contract.md \
    docs/98.archive/04.execution/tasks/2026-07-17-archive-record-and-workspace-boundary.md; do
