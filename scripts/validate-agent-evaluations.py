#!/usr/bin/env python3
"""Compatibility CLI for registry-derived static evaluation boundaries."""
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Validate static evaluation boundaries through the agent registry."
    )
    ...
    try:
        ...
        print(f"[PASS] agent evaluations{suffix}: {compat.format_counts(counts)}")
        return 0
