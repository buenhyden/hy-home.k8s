...
├── document_contracts.py             # Closed registry v7 loader with immutable value, role, admission, lifecycle, evidence, lineage, inventory, and classifier projections
...
├── validate-document-contract-registry.py # Registry v7 schema, typed lifecycle/evidence and program lineage, inventory, routes, Stage 00 owners, and Current reference packs
...
root/nested duplicate-key와 noncanonical Tombstone baseline probe, private
