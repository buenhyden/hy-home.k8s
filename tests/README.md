...
| Agent role semantics fixture | `python3 scripts/validate-agent-role-semantics.py --self-test` | Repo-static 768-case category mutation evidence plus nine closed Gemini-native five-field metadata mutations; model/tool candidates are deliberately outside adapter frontmatter |
