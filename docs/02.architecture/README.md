...
원래 profile 그대로 보존한다([ADR-0039](./decisions/0039-unit-archive-retention-and-citation-table.md), accepted; SPEC-0082 machine 전환 전까지 검증기는 ADR-0038 route를 따른다). 대체된 ADR은
