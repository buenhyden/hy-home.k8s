---
title: 'ADR 0026: Mutable Target Revision Retention'
type: sdlc/adr
status: accepted
owner: platform
updated: 2026-08-18
...
# ADR 0026: Mutable Target Revision Retention

## Overview

[ADR 0023](0023-argo-cd-source-integrity-non-adoption.md) declined Argo CD Source
...
that recommendation up and declines it, for a reason ADR 0023 did not examine:
...
- It does not reopen ADR 0023's Source Integrity decision, which remains declined
...
substantive difference from ADR 0023's position: a reader no longer finds a
...
**Commit-SHA pinning — recommended by ADR 0023, declined here.** Gives exact
...
| ------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| [ADR 0023](0023-argo-cd-source-integrity-non-adoption.md) preferred control | Resolves ADR 0023's unexecuted recommendation by declining it; supersedes no decision and reverses no adoption | N/A — standalone decision record with no execution scope |

### Related Documents

- [ADR 0023 — Argo CD source integrity non-adoption](0023-argo-cd-source-integrity-non-adoption.md)
