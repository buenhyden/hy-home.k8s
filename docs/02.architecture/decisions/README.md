...
| [`./0020-document-lifecycle-program-closure-evidence.md`](./0020-document-lifecycle-program-closure-evidence.md) | PRD-006 / ARD-0009 문서 수명주기 프로그램 closure evidence 결정 | Active | CCPC-002 closure matrix와 Current-audit reconciliation이 `b8d38d1`에 durable해져 활성화됐으며, final QA 뒤 Spec 040 closure에서 ADR-0020과 ARD-0009의 same-diff acceptance evidence를 제공한다. |
