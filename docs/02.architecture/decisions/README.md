...
| [`./0024-terminal-artifact-identity-and-archive-layout.md`](./0024-terminal-artifact-identity-and-archive-layout.md) | Architecture Description, global artifact identity, stable Stage 98, and exact script-disposition successor | Active | `WDTC-AMEND-001` terminal/current design; WORK-105 must atomically convert ARD-0011 with archive-invariant replacement, accept this record, and change the registry projection. ADR-0023 remains the accepted transition decision until then. |
