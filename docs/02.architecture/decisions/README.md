...
| [`./0023-work-unit-document-taxonomy-and-governance-authority.md`](./0023-work-unit-document-taxonomy-and-governance-authority.md) | Work-unit document topology, stable Stage 05, and governance-authority decision | Active | Written design and implementation planning are approved; lifecycle acceptance and the atomic PRD-008 registry correction are the first implementation package. |
