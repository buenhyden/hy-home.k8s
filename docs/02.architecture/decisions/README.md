...
| [`./0024-terminal-artifact-identity-and-archive-layout.md`](./0024-terminal-artifact-identity-and-archive-layout.md) | Architecture Description, complete ARD retirement, two-gate authored API Spec retirement, closed mandatory/prohibited artifact identity, virtual Stage 98 change identity, stable archive, and exact script-disposition successor | Active | `WDTC-AMEND-001` terminal/current design; WORK-105 must convert the exact active/accepted ARD-0004 through ARD-0011 census one-to-one to AD-0004 through AD-0011, preserve IDs/slugs/statuses, and leave zero unconverted current ARDs or live/unclassified ARD consumers. Within that full migration, AD-0011 invariant replacement plus this record's acceptance and the registry projection change are a separate atomic gate. API Spec instance/consumer gates and native/history preservation also remain mandatory. ADR-0023 stays the accepted transition decision until every gate passes. |
