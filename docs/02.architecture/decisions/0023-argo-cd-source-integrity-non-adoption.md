---
title: 'ADR 0023: Argo CD Source Integrity Non-adoption'
type: sdlc/adr
status: accepted
owner: platform
updated: 2026-08-18
...
# ADR 0023: Argo CD Source Integrity Non-adoption
...
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| Direct human approval recorded in the Spec body | N/A — first non-adoption decision over a fired research refresh trigger; supersedes no prior ADR | [Spec 059](../../03.specs/059-platform-currency-defect-closure/spec.md) |
