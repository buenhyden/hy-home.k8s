...
| [AD-0007](./0007-current-local-gitops-platform.md) | 로컬 GitOps와 delivery assurance 구조 | Active | Desired-state topology, external interfaces, layered validation, native IaC, revision/namespace evidence; AD-0006과 공통 경계 분리. | [Spec 0049](../../03.specs/0049-platform-validation-and-security-evidence/spec.md) 2026-09-25 철회, 범위는 owner 없는 gap; 0047·0048·0050·0051 철회 후 retired 보존 |
