...
| [`./003-workspace-agent-governance-platform.md`](./003-workspace-agent-governance-platform.md) | Workspace AI Agent governance, provider-native harness, loop, model, and evidence program PRD | Active | ARD-0006과 현재 baseline ADR-0013을 유지하면서 active candidate ADR-0019 및 Specs 041–046의 기반 우선 후속 프로그램을 정의한다. Repository-local closure와 provider-runtime readiness를 분리한다. | 2026-08-01 |
