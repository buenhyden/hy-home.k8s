...
| [`./007-repository-delivery-and-platform-assurance.md`](./007-repository-delivery-and-platform-assurance.md) | Repository delivery, GitHub routing, platform validation, IaC QA, and local integration assurance program PRD | Active | ARD-0010과 ADR-0021을 기반으로 Spec 047을 첫 active tranche로 실행하고 planned Specs 048–051의 경계를 정의한다. PRD-004/ARD-0007/ADR-0014/Spec 008의 current platform topology 소유권과 remote/live approval boundary는 유지한다. | 2026-08-02 |
| [`./008-workspace-document-taxonomy-consolidation.md`](./008-workspace-document-taxonomy-consolidation.md) | Workspace document taxonomy, identifier, rule-ownership, and governance corpus consolidation program PRD | Draft | ARD-0011과 Spec 052를 통해 execution stage 폐지, work unit 통합, lineage frontmatter, 규칙 문서 통합, corpus 감축을 정의한다. PRD-007은 본 프로그램 기간 동안 suspend되며 archive 불가침과 stage identifier 안정성은 보존한다. | 2026-08-07 |
