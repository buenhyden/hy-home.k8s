...
| [`./006-workspace-document-lifecycle-and-evidence-consolidation.md`](./006-workspace-document-lifecycle-and-evidence-consolidation.md) | Workspace document lifecycle, archive, reference, and QA evidence consolidation program PRD | Done | 2026-07-28 기준 ARD-0009, ADR-0017/0018/0020, Specs 034–040과 통합 repository-static contract는 exact 14-path terminal proposal에서 종료됐다. Final frontier는 `0/0·6/3·3`이고 reviewed digest `e146fb13fb3a62db014e6317992a4f519b79ba330253c4c5fe89834dc67e1888`은 terminal requirements/quality/security approval을 받았다. Future commit/explicit-ref/clean-tree postflight와 hosted/provider/remote/live는 주장하지 않는다. | 2026-07-28 |
