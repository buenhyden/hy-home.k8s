...
| [`./003-workspace-agent-governance-platform.md`](./003-workspace-agent-governance-platform.md) | Workspace AI Agent governance, provider-native harness, loop, model, and evidence program PRD | Active | ARD-0006과 현재 baseline ADR-0013을 유지하면서 draft ADR-0019 및 Specs 041–046이 038–040 종료 후 시작할 기반 우선 후속 프로그램을 정의한다. | 2026-07-22 |
