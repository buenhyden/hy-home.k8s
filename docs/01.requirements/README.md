...
위 내용은 각각 `02.architecture/requirements/`, `02.architecture/decisions/`, `03.specs/`, `05.operations/runbooks/`로 분리한다.
...
- `02.architecture/requirements/`: PRD 요구를 시스템 경계와 품질 속성으로 확장한다.
- `03.specs/`: PRD 요구를 구현 가능한 계약으로 구체화한다.
- `04.execution/plans/`: PRD와 Spec을 실행 순서로 전환한다.
