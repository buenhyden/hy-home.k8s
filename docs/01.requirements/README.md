...
| [`./008-workspace-document-taxonomy-consolidation.md`](./008-workspace-document-taxonomy-consolidation.md) | Workspace document taxonomy, identifier, rule-ownership, and governance corpus consolidation program PRD | Active | ARD-0011과 Spec 052를 통해 execution stage 폐지, work unit 통합, lineage frontmatter, 규칙 문서 통합, corpus 감축을 정의한다. PRD-007은 active로 유지된 채 본 프로그램 기간 동안 실행만 일시 중단되며 archive 불가침과 stage identifier 안정성은 보존한다. | 2026-08-07 |
