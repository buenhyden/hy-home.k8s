...
- **REQ-0003-FR-0008**: Only currently admitted provider surfaces may be projected, and a planned or absent surface must not count as current support.
...
- **REQ-0003-FR-0024**: A compatibility layer, wrapper, or script is kept only while it has a real consumer and a unique rule or negative fixture, and is removed after succession evidence and consumer-zero.
...
- **REQ-0003-FR-0026**: Repository-declared, provider-runtime, hosted-CI, and approved remote/live evidence must be kept apart and never promoted into one another without observation.
...
| REQ-0003-FR-0024 | A compatibility layer, wrapper, or script is kept only while it has a real consumer and a unique rule or negative fixture, and is removed after succession evidence and consumer-zero. Whether it is met is judged by the owner's static validation and separate observed evidence. | [AD-0006](../02.architecture/descriptions/0006-workspace-agent-governance-platform.md) |
