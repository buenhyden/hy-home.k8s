...
- ADR-0019와 ADR-0013은 predecessor 실행과 external-lane limitation을
  보존하는 superseded historical decisions다. ADR-0036과 SPEC-0072가 현재 거버넌스 위치와 QA·CD 경계를 소유한다. ADR-0034는 그 경계를 ADR-0035에, ADR-0035는 ADR-0036에 승계한 superseded decision이다.
...
[0049](../03.specs/0049-platform-validation-and-security-evidence/spec.md)는 재계획을 기다리는 draft다.
...
REQ-0006의 Plan/Task-only retention과 REQ-0008의 모든 Stage 98 링크 금지는 ADR-0038의 disposition과 ADR-0039의 순서 있는 인용 표로 대체된다. 봉인 record는 계속 current authority가 아니다.
