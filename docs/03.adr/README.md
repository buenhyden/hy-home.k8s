...
| [`0011-argo-rollouts-progressive-delivery.md`](./0011-argo-rollouts-progressive-delivery.md)                           | Argo Rollouts v1.9.0 도입, Rollouts Dashboard 포함, 수동 promotion 기본 결정                                     | Accepted | 2026-03-30 |
