...
`infrastructure/vault/policies/eso-read.hcl`에 새 경로를 추가한다:

```hcl
path "secret/data/apps/<appname>/*" {
  capabilities = ["read"]
}
```
...
- **Operations 정책**: [`../08.operations/0007-app-gitops-onboarding-policy.md`](../08.operations/0007-app-gitops-onboarding-policy.md)
