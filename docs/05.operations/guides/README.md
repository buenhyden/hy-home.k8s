...
| [`./0010-ci-cd-qa-reference-guide.md`](./0010-ci-cd-qa-reference-guide.md)                     | CI/CD QA 검증 로컬-vs-GitHub Actions 경계, script gate, currentness gate 참조 가이드 | Active | 2026-06-04 |
