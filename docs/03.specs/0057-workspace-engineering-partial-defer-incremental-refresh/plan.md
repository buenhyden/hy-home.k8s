...
- Source and claim records live in
  `source-coverage.md`. Workstreams emit reviewed
...
- [x] **Step 3: Freeze the baseline ledger through the checker.** Run:
  ...
  ```bash
  python3 /tmp/pdrr-refresh-check.py snapshot-ledger --source docs/90.references/research/0001-workspace-engineering/source-coverage.md --output /tmp/pdrr-ledger-before.md
