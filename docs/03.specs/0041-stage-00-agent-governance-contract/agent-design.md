...
- **Foundation**: [Spec 039](../0039-github-ci-qa-evidence/spec.md) and
  [Spec 040](../0040-contract-cutover-and-program-closure/spec.md)
- **Provider evidence**: [Spec 042](../0042-provider-native-runtime-and-model-evidence/spec.md)
- **Loop lifecycle**: [Spec 043](../0043-agent-harness-loop-lifecycle/spec.md)
- **Admission and eval owner**: [Spec 044](../0044-agent-roster-evaluation-and-admission/spec.md)
- **CI/QA cutover**: [Spec 045](../0045-agent-governance-ci-qa-cutover/spec.md)
- **Closure**: [Spec 046](../0046-agent-governance-program-closure/spec.md)

### Lifecycle Traceability

| PRD requirement | Spec criterion | Verification method |
| --- | --- | --- |
| [REQ-PRD-FUN-12](../../01.requirements/0003-workspace-agent-governance-platform.md#functional-requirements) | VAL-SAGC-AD-001 | Exact-set fixtures prove 12 canonical roles and one projection per role per surface. |
| N/A — shared PRD 003 source above | VAL-SAGC-AD-002 | Roster/schema validators reject missing, extra, duplicate, or orphan adapters. |
| N/A — shared PRD 003 source above | VAL-SAGC-AD-003 | Role eval and model-fitness records prove structured semantics and provider-specific selection. |
