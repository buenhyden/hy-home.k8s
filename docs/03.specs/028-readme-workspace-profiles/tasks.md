...
- **Completed Registry Spec**: [Document Contract Registry](../026-document-contract-registry/spec.md)
- **Completed Template Spec**: [Template Contract Consolidation](../027-template-contract-consolidation/spec.md)
- **Semantic Validator Consumer**: [Semantic Document Validation](../029-semantic-document-validation/spec.md)
- **Authored Corpus and Handoff Migration Owner**: [Authored Document Migration](../030-authored-document-migration/spec.md)
...
- **Previous Registry Tranche**: [Document Contract Registry](../026-document-contract-registry/spec.md)
- **Previous Template Tranche**: [Template Contract Consolidation](../027-template-contract-consolidation/spec.md)
- **Semantic Validation Consumer**: [Semantic Document Validation](../029-semantic-document-validation/spec.md)
- **Authored Migration Owner**: [Authored Document Migration](../030-authored-document-migration/spec.md)
