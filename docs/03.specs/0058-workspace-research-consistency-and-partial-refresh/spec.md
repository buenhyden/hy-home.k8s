...
| Source and claim ledger | `docs/90.references/research/0001-workspace-engineering/m0012-source-coverage.md` | Append-only `SRC`/`CLM` registration                  |
| Scope application index | `docs/90.references/research/0001-workspace-engineering/m0013-scope-application-index.md`              | Scope re-projection and unowned-path list             |
