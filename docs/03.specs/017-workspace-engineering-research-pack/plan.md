...
- **Prior Research Spec**: [Workspace Harness Research Pack](../009-workspace-harness-research-pack/spec.md)
- **Task**: [../tasks/2026-07-04-workspace-engineering-research-pack.md](tasks.md)
