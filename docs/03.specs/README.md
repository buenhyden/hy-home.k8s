...
| [`./036-archive-record-and-workspace-boundary/spec.md`](./036-archive-record-and-workspace-boundary/spec.md) | Archive record and workspace boundary specification | Active | Spec 035 완료 뒤 첫 dependency-ready tranche다. 31개 Tombstone full-body archive와 `_workspace` 경계를 소유하며 현재 Plan/Task는 0개다. | 2026-07-15 |
