...
| [`./053-workspace-engineering-research-pack-consolidation/spec.md`](./053-workspace-engineering-research-pack-consolidation/spec.md) | Workspace engineering research pack consolidation and replacement specification | Draft | 2026-08-08 기준 외부·워크스페이스 재조사, 신규 12-reference 통합 팩, 25개 predecessor disposition, mutable Cross-Link와 reference-IA 전환, 세 기존 팩 삭제를 fail-closed 검증과 논리 커밋으로 정의한다. Stage 98은 불변이고 provider/runtime/hosted/remote/live 증거는 주장하지 않는다. | 2026-08-08 |
