...
| [`./040-contract-cutover-and-program-closure/spec.md`](./040-contract-cutover-and-program-closure/spec.md) | Contract cutover and program closure specification | Active | activation `5c7bb820`, strict-only CCPC-001 `0ae1fcd3`, postflight `98ed9c6`을 관측했다. CCPC-002 closure matrix와 Current audit reconciliation이 진행 중이며 post-change remote CI는 별도 `DEFER` evidence lane으로 유지한다. | 2026-07-27 |
