...
| [`./0089-deferred-conflict-resolution/spec.md`](./0089-deferred-conflict-resolution/spec.md) | Deferred conflict resolution | Draft | 2026-09-25 request owner 요청으로 SPEC-0088의 deferred conflict를 해소하고 현재 authority와 상충하는 열린 package를 철회·정리한다. | 2026-09-25 |
