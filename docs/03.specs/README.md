...
| [`./041-stage-00-agent-governance-contract/spec.md`](./041-stage-00-agent-governance-contract/spec.md) | Stage 00 agent governance contract specification | Done | PRD-003/ARD-0006와 current accepted ADR-0013 program lineage의 첫 tranche로 provider-neutral harness machine contract, current 10/30과 target-only 12/48 분리, 네 memory class의 authority/provenance/sensitivity/promotion 경계, consumer migration, routing, QA/review를 완료했다. ADR-0019는 Spec 046 acceptance 전까지 proposed successor이며 provider/runtime/live 결과는 `DEFER`다. | 2026-07-28 |
| [`./042-provider-native-runtime-and-model-evidence/spec.md`](./042-provider-native-runtime-and-model-evidence/spec.md) | Provider native runtime and model evidence specification | Active | Claude, Codex, Gemini native surface와 model/effort/MCP 설정 및 독립 runtime canary evidence class를 정규화한다. Reciprocal [Plan](../04.execution/plans/2026-07-28-provider-native-runtime-and-model-evidence.md)과 [Task](../04.execution/tasks/2026-07-28-provider-native-runtime-and-model-evidence.md)가 활성 실행 증거를 소유한다. | 2026-07-28 |
