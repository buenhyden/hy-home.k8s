...
| [`./039-github-ci-qa-evidence/spec.md`](./039-github-ci-qa-evidence/spec.md) | GitHub CI and QA evidence specification | Done | GCQE-001~005의 reviewed repository-static 구현과 GCQE-006 exact eight-file terminal proposal을 기록한다. Digest `58640a0d…`에 대한 final requirements/quality review는 승인되었고 Spec 040은 Active이며 closure SHA와 explicit-ref/clean-tree postflight는 pending·unclaimed다. Hosted run `29982910320`은 과거 exact-SHA FAIL이고 current hosted/provider/live는 `DEFER`다. | 2026-07-26 |
| [`./040-contract-cutover-and-program-closure/spec.md`](./040-contract-cutover-and-program-closure/spec.md) | Contract cutover and program closure specification | Active | compatibility 제거, strict corpus cutover, 전체 검증과 독립 closure review를 소유하며 post-change remote CI는 별도 evidence lane으로 유지한다. | 2026-07-26 |
