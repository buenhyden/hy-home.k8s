...
| [`./043-agent-harness-loop-lifecycle/spec.md`](./043-agent-harness-loop-lifecycle/spec.md) | Agent harness loop lifecycle specification | Active | Spec 042 폐쇄 이후 exact retry/recovery ceiling, non-retryable classes, repository-wins checkpoint/resume, four-class memory lifecycle, compaction, handoff, escalation을 구현한다. Reciprocal [Plan](../04.execution/plans/2026-07-29-agent-harness-loop-lifecycle.md)과 [Task](../04.execution/tasks/2026-07-29-agent-harness-loop-lifecycle.md)가 활성 실행 증거를 소유한다. | 2026-07-29 |
