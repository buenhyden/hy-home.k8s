...
| [`./053-workspace-engineering-research-pack-consolidation/spec.md`](./053-workspace-engineering-research-pack-consolidation/spec.md) | Workspace engineering research pack consolidation and replacement specification | Active | 2026-08-08 승인에 따라 외부·워크스페이스 재조사, 신규 12-reference 통합 팩, 25개 predecessor disposition, mutable Cross-Link와 reference-IA 전환, 세 기존 팩 삭제를 fail-closed 검증과 논리 커밋으로 실행한다. Stage 98은 불변이고 provider/runtime/hosted/remote/live 증거는 주장하지 않는다. | 2026-08-08 |
