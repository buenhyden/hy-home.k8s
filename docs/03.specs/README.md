...
| [`./039-github-ci-qa-evidence/spec.md`](./039-github-ci-qa-evidence/spec.md) | GitHub CI and QA evidence specification | Active | 원격 실패 SHA를 보존하면서 affected/all-files QA, pinned CI dependencies, explicit pre-commit 실행, aggregate verdict와 portability 경계를 정리한다. | 2026-07-26 |
