...
| [`./031-affected-surface-agent-qa/spec.md`](./031-affected-surface-agent-qa/spec.md)                                           | Affected surface and Agent QA specification                                   | Active | reciprocal [Plan](../04.execution/plans/2026-07-12-affected-surface-agent-qa.md)과 [Task](../04.execution/tasks/2026-07-12-affected-surface-agent-qa.md)에 따라 변경 경로, local hook, pre-commit, AI Agent 의무, provider gateway, CI selector를 하나의 검증 계약으로 정렬한다. | 2026-07-14 |
