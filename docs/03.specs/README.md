...
| [`./037-active-corpus-and-execution-retention/spec.md`](./037-active-corpus-and-execution-retention/spec.md) | Active corpus and execution retention specification | Done | ACER-001~005의 reviewed repository-static 결과와 ACER-006 terminal staged-closure proposal을 기록한다. 현재 Stage 04는 49 Plan/51 Task, 52 lineage의 48/1/3 cardinality, 100 `DEFER`/0 `retain`, accepted ADR 13개와 done Spec 29개 guard, findings 0이다. closure commit과 clean-tree post-commit 검증은 pending이며 주장하지 않는다. | 2026-07-19 |
