...
| [`./026-document-contract-registry/spec.md`](./026-document-contract-registry/spec.md)                                         | Document contract registry specification                                      | Done   | Registry schema v4와 `DocumentProfileContract.v2`가 62개 문서 profile의 route, metadata, lifecycle, section, README, local/native 예외를 machine-readable 단일 정본으로 정의한다.                                                                                                                               | 2026-07-14 |
