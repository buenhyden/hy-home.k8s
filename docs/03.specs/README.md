...
| [`./054-workspace-governance-audit-and-remediation/spec.md`](./054-workspace-governance-audit-and-remediation/spec.md) | Workspace governance audit, canonical-owner remediation, current-pointer cutover, and evidence-gated cleanup specification | Active | 2026-08-09 직접 승인과 Spec 승인에 따라 reciprocal Plan/Task 및 ADR-0022 standalone execution을 활성화했다. 30개 요청 범위를 신규 10-file Current 감사 팩으로 조사하고, 목적 충돌·중복 권한을 canonical owner에서 정리하며, proof-complete Legacy/Deprecated/일회성 항목만 삭제한다. 기존 감사 팩은 source-commit 고정 역사 증거로 보존하고 hosted/provider/remote/live 결과는 `DEFER`한다. | 2026-08-09 |
