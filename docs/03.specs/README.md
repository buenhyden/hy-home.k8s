...
| [`./038-reference-information-architecture/spec.md`](./038-reference-information-architecture/spec.md) | Reference information architecture specification | Active | Reciprocal [Plan](../04.execution/plans/2026-07-22-reference-information-architecture.md)과 [Task](../04.execution/tasks/2026-07-22-reference-information-architecture.md)가 RIA-000~007의 closed contract, code-owned Current root FSM, stage-zero authority, bounded transition/settlement lineage, source·generator·duplicate-owner·closure를 정의한다. RIA-000은 `cb0c1f6`, RIA-001은 `68e46fc`·`566c74f`·`15bba3d`와 clean final review로 Completed다. RIA-002는 design correction review까지 In Progress이며 implementation RED는 시작하지 않았다. | 2026-07-22 |
