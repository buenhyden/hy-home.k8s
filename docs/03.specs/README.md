...
| [`./036-archive-record-and-workspace-boundary/spec.md`](./036-archive-record-and-workspace-boundary/spec.md) | Archive record and workspace boundary specification | Done | ARWB-001부터 ARWB-005까지 31개 full-body Archive Record, 202개 historical link, archive 권위, `_workspace` metadata-only 경계를 구현·폐쇄했다. 독립 whole-tranche 검토를 통과한 reciprocal [Plan](../04.execution/plans/2026-07-17-archive-record-and-workspace-boundary.md)과 [Task](../04.execution/tasks/2026-07-17-archive-record-and-workspace-boundary.md)는 closure commit `855fa78` 및 postflight corrections `cdac53c`, `a12aedf`까지 기록한다. | 2026-07-18 |
| [`./037-active-corpus-and-execution-retention/spec.md`](./037-active-corpus-and-execution-retention/spec.md) | Active corpus and execution retention specification | Active | Reciprocal [Plan](../04.execution/plans/2026-07-18-active-corpus-and-execution-retention.md)과 [Task](../04.execution/tasks/2026-07-18-active-corpus-and-execution-retention.md)가 parent 54 Plan/56 Task 후보 inventory와 104+6 census 의무를 활성화했으며 staged pair를 포함한 proposed corpus는 55/57이다. Activation review는 `REQUIREMENTS COMPLIANT`, `QUALITY APPROVED`, findings none이며 ACER-001~006은 Queued다. 종료 lineage의 eligible execution record만 full-body archive하고 Stage 05/helper Tests 역할과 active-stage cardinality를 검증한다. | 2026-07-18 |
