...
| [`./024-observability-and-network-review-agents/spec.md`](./024-observability-and-network-review-agents/spec.md)                 | Observability and network review agents specification                         | Draft  | `observability-reviewer`와 `network-reviewer` worker 에이전트를 3개 provider 어댑터와 harness catalog에 추가하는 repo-static, review-only 설계를 정의한다.                                                                                                                        | 2026-07-06 |
| [`./025-governance-owner-and-roster-currentness/spec.md`](./025-governance-owner-and-roster-currentness/spec.md)                 | Governance owner and roster currentness specification                         | Active | 전체 Spec/Plan 생명주기와 감사 IA를 증거 기반으로 정합화하고, RMD-004의 10-role/30-adapter roster 및 canonical-owner currentness 계약과 검증 경계를 정의한다.                                                                                                                     | 2026-07-11 |
