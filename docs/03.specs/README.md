...
| [`./025-governance-owner-and-roster-currentness/spec.md`](./025-governance-owner-and-roster-currentness/spec.md)                 | Governance owner and roster currentness specification                         | Draft  | 전체 Spec/Plan 생명주기와 감사 IA를 증거 기반으로 정합화하고, RMD-004의 10-role/30-adapter roster 및 canonical-owner currentness 계약과 검증 경계를 정의한다.                                                                                                                     | 2026-07-11 |
