...
| [`./030-authored-document-migration/spec.md`](./030-authored-document-migration/spec.md)                                       | Authored document migration specification                                     | Active | reciprocal [Plan](../04.execution/plans/2026-07-12-authored-document-migration.md)과 [Task](../04.execution/tasks/2026-07-12-authored-document-migration.md)에 따라 전 문서 모집단을 wave별로 이행하고 AWS/Azure SDLC prose를 Stage 90 provider snapshot으로 통합한다.                    | 2026-07-13 |
