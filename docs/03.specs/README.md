...
| [`./0030-authored-document-migration/spec.md`](./0030-authored-document-migration/spec.md)                                       | Authored document migration specification                                     | Done | reciprocal [Plan](0030-authored-document-migration/plan.md)과 [Task](0030-authored-document-migration/tasks.md)에 따라 전 문서 모집단을 wave별로 이행하고 AWS/Azure SDLC prose를 Stage 90 provider snapshot으로 통합한다.                    | 2026-07-13 |
...
| [`./0062-workspace-research-full-corpus-reverification/spec.md`](./0062-workspace-research-full-corpus-reverification/spec.md) | Full-corpus external-source and workspace reverification design over the existing WER research pack | Draft | 2026-08-20 직접 승인된 설계로, 기존 36개 `REQ-WERPC` owner를 외부·workspace 증거로 전수 재검증하고 결과를 기존 14-file 연구 팩에 증분 통합한다. 실행은 written Spec과 후속 Plan의 별도 승인 전까지 시작하지 않는다. | 2026-08-20 |
