...
| [`./0087-stage03-terminal-package-retention/spec.md`](./0087-stage03-terminal-package-retention/spec.md) | Stage 03 terminal package retention | Draft | 2026-09-24 request owner 승인("Approve archive, separate package")으로 withdrawn package 네 개(0047·0048·0050·0051)를 `retired/`로, done package 세 개(0054·0062·0084)를 `completed/`로 두 번에 나눠 보존한다. | 2026-09-24 |
