...
| [`./038-reference-information-architecture/spec.md`](./038-reference-information-architecture/spec.md) | Reference information architecture specification | Done | Reciprocal [Plan](../04.execution/plans/2026-07-22-reference-information-architecture.md)과 [Task](../04.execution/tasks/2026-07-22-reference-information-architecture.md)는 RIA-000~006의 reviewed contract/FSM, stage-zero authority, source·generator·duplicate-owner 증거와 RIA-007 C1 lifecycle proposal을 기록한다. RIA-002~006은 exact observed commits, focused 37/43/46/81/82, repository gates, package review로 Completed다. C1은 six lifecycle paths와 registry Spec 038 program-lineage state를 합친 exact seven tracked paths를 `done`으로 제안하며 ledger/contract는 변경하지 않는다. Whole-tranche review와 C1/C2/C3 identity·postflight·settlement는 pending·unclaimed이다. | 2026-07-26 |
