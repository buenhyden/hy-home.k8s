...
pre-WORK-104 amendment. WORK-100 through WORK-104 and `WDTC-AMEND-001` are
complete; WORK-105 through WORK-115 remain the only successor work items.
...
| WORK-105 | VAL-WDTC-004, VAL-WDTC-013 | Convert exactly eight ARDs to ADs, close ARD/API-Spec consumers, activate core forms, and accept the AD-0011/ADR-0024/projection gate. | platform | Queued | Not executed | Eight-record census, complete classifiers, atomic acceptance, native/history retention |
| WORK-106 | VAL-WDTC-006, VAL-WDTC-014, VAL-WDTC-015 | Implement artifact-ID and migration-ledger transition validators. | platform | Queued | Not executed | Global identity and 14-field ledger positive/negative fixtures |
...
| WORK-108 | VAL-WDTC-003, VAL-WDTC-014 | Backfill mandatory outer artifact IDs after WORK-105 acceptance. | platform | Queued | Not executed | Mandatory/prohibited namespace and global uniqueness evidence |
...
was performed or claimed. WORK-105 is the next owner; WORK-107 and WORK-108
remain blocked by WORK-105's complete eight-AD conversion and acceptance.
...
| [WORK-105](plan.md#work-breakdown) | Not executed. | Exact AD/ARD/API-Spec conversion and authority acceptance pending. |
| [WORK-106](plan.md#work-breakdown) | Not executed. | Artifact-ID and migration-ledger validators pending. |
| [WORK-107](plan.md#work-breakdown) | Not executed. | Stable 93-record Stage 98 rehome pending WORK-105 acceptance. |
| [WORK-108](plan.md#work-breakdown) | Not executed. | Global artifact-ID backfill pending complete AD conversion. |
