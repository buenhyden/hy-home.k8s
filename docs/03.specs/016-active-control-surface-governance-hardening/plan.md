...
- **Prior Spec**: [Workspace Document Governance Hardening](../013-workspace-document-governance-hardening/spec.md)
- **Prior Spec**: [Workspace Document Contract Normalization](../014-workspace-document-contract-normalization/spec.md)
- **Prior Spec**: [Agent Governance Contract Normalization](../015-agent-governance-contract-normalization/spec.md)
- **Task**: [../tasks/2026-07-04-active-control-surface-governance-hardening.md](tasks.md)
