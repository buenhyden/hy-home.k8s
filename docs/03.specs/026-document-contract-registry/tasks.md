...
- **Parent Spec**:
  [../../03.specs/026-document-contract-registry/spec.md](spec.md)
- **Parent Plan**:
...
- **Plan**:
  [../plans/2026-07-12-document-contract-registry.md](plan.md)
- **Next Spec**:
  [../../03.specs/027-template-contract-consolidation/spec.md](../027-template-contract-consolidation/spec.md)
