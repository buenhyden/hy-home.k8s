...
- [Predecessor Spec 038 Task](../0038-reference-information-architecture/tasks.md)
...
- **Spec**:
  [Spec 039](spec.md)
- **Predecessor Task**:
  [Reference Information Architecture Task](../0038-reference-information-architecture/tasks.md)
