...
| AD                     | `REQ-WERPC-012`               | `spec-driven-sdlc-and-document-contracts.md#document-family-contract-matrix`          | N/A — local-only evidence                                        | `CLM-WERPC-003-03`                                                            | `admit-under-sourced-partial` | The typed local AD contract is verified, but no direct external architecture-requirements source distinguishes constraints, quality attributes, interfaces, risks, and decision handoff.                                                                             |
