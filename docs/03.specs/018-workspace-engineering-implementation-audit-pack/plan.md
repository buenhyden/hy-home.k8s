...
```bash
git add docs/90.references/audits/2026-07-05-wea docs/90.references/audits/README.md docs/04.execution/tasks/2026-07-05-workspace-engineering-implementation-audit-pack.md
...
```bash
git add docs/90.references/audits/2026-07-05-wea docs/04.execution/tasks/2026-07-05-workspace-engineering-implementation-audit-pack.md
...
- **Research Pack Spec**: [../../03.specs/017-workspace-engineering-research-pack/spec.md](../017-workspace-engineering-research-pack/spec.md)
- **Prior Audit Pack Spec**: [../../03.specs/010-workspace-harness-implementation-audit-pack/spec.md](../010-workspace-harness-implementation-audit-pack/spec.md)
- **Task**: [../tasks/2026-07-05-workspace-engineering-implementation-audit-pack.md](tasks.md)
