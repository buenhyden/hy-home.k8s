...
[Spec 017](../017-workspace-engineering-research-pack/spec.md). It does not
reopen or rewrite Spec 017's terminal evidence. It also records a deliberate
conflict with the active [Spec 052](../052-document-taxonomy-consolidation/spec.md)
...
- **Predecessor specification**:
  [Spec 017](../017-workspace-engineering-research-pack/spec.md)
- **Related consolidation specification**:
  [Spec 052](../052-document-taxonomy-consolidation/spec.md)
...
| --- | --- | --- |
| N/A — the direct human-approved research consolidation has no separate PRD; PRD-008 is a conflicting input to reconcile, not the authority for deletion. | VAL-WER-001 | Exact tracked-file inventory proves the declared pack shape. |
