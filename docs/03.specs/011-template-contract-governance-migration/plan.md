...
- **Spec**: [../../03.specs/011-template-contract-governance-migration/spec.md](spec.md)
- **Tasks**: [../tasks/2026-07-03-template-contract-governance-migration.md](tasks.md)
