...
| WP-007 | Decide citation in the shared resolver, consume it in the link validator, and remove the duplicate loop                                     | WP-006                      | Failing citation regressions and a coverage-equivalence regression | Link and archive regressions       |
