...
| --- | --- | --- | --- | --- | --- | --- |
| CSASR-005 | VAL-CSASR-008, VAL-CSASR-009 | Run QA/review, close Spec 047, and hand off to Spec 048 | platform | Cancelled | Not executed | Focused/strict/affected/aggregate/all-files/diff/review evidence and reciprocal closure |
...
| --- | --- | --- |
| N/A — legacy work item `CSASR-005` | Cancelled (2026-09-24): the owning Spec is withdrawn. | Row-specific result and evidence remain in the Task Table above. |
