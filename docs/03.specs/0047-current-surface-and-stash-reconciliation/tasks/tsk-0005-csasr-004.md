...
| --- | --- | --- | --- | --- | --- | --- |
| CSASR-004 | VAL-CSASR-005 | Regenerate only validator-proven stale derived evidence with current producer | platform | Cancelled | Not executed | Current generator command/result and residue validator evidence, or evidence-backed no-change |
...
| --- | --- | --- |
| N/A — legacy work item `CSASR-004` | Cancelled (2026-09-24): the owning Spec is withdrawn. | Row-specific result and evidence remain in the Task Table above. |
