...
| --- | --- | --- |
| [REQ-PRD-MET-02](../../01.requirements/003-workspace-agent-governance-platform.md#success--acceptance-criteria) | VAL-AGPC-001 | Predecessor and lineage validation proves the reciprocal program chain. |
