...
- **Spec**: [../../03.specs/023-stage03-04-repo-static-gap-closure/spec.md](spec.md)
- **Planned Tasks Path**: `../tasks/2026-07-06-stage03-04-repo-static-gap-closure.md`
- **WER Plan**: [./2026-07-04-workspace-engineering-research-pack.md](../017-workspace-engineering-research-pack/plan.md)
- **WER Task**: [../tasks/2026-07-04-workspace-engineering-research-pack.md](../017-workspace-engineering-research-pack/tasks.md)
- **SDLC Lifecycle Contract Spec**: [../../03.specs/021-sdlc-lifecycle-contract/spec.md](../021-sdlc-lifecycle-contract/spec.md)
