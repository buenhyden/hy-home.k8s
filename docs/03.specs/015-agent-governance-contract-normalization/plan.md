...
- **Spec**: [../../03.specs/015-agent-governance-contract-normalization/spec.md](spec.md)
- **Task**: [../tasks/2026-07-04-agent-governance-contract-normalization.md](tasks.md)
