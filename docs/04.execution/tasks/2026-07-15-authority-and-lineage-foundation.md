...
| ALF-004 | VAL-ALF-001 through VAL-ALF-007 | Run full QA, independent review, and atomic lifecycle closure. | platform | Paused | Waiting for ALF-002C independent approval. | Command matrix, review verdicts, rollback parent, and closure commit will be recorded only after the closure-gap correction is approved. |
...
| [ALF-004](../plans/2026-07-15-authority-and-lineage-foundation.md#task-4-validate-and-close-the-authority-foundation) | Queued. | Closure may resume now that ALF-002C has independent requirements and quality approval. |
