...
`9c18910`; four eligible lineage batches remain. ACER-004 through ACER-006
remain Queued. Produced evidence is recorded below.
...
| ACER-003 | VAL-ACER-002, VAL-ACER-006 | Migrate eligible execution records in atomic per-lineage full-body archive batches. | platform | In Progress | Batch `ACER-003-001` migrated the first deterministic eligible pair, `2026-07-12-affected-surface-agent-qa`, in independently approved logical commit `28b42e7`. Batch `ACER-003-002` migrated the second pair, `2026-07-12-protected-surface-supply-chain-hardening`, in independently approved logical commit `9c18910`. Four eligible batches remain, so ACER-003 is not Done. | Batch 1 retains its committed exact two-record/16-link evidence and rollback parent `90d496e4e96c172785eb23071173a7751e688fd1`. Batch 2 RED changed only the focused contract: the old one-batch snapshot exited 1 with three failures and one missing-second-row error. GREEN and clean-tree postflight pass eight focused tests, the exact 17-case self-test, production migration `2/4/35/233/4/7`, generic archive recovery 15 tests, generic archive validation 22 tests, full archive cutover regression 21 tests, production archive `35/233/35`, strict registry/Markdown/cross-document validation, and the repository aggregate. Requirements review was `REQUIREMENTS COMPLIANT`; quality review was `QUALITY APPROVED`; findings were none. The second rollback parent is `b390d54cab5c4b94960878f8d7f4fd887d18a132`; six batch-2 consumers are repaired. The Plan payload is 59,438 bytes with SHA-256 `df5a5f4569fa33996700514ec50364b358d89a1d45f1d7de86da19fb386aa4e8` and seven historical links; the Task payload is 17,762 bytes with SHA-256 `a10f56bf7501369e79969f10417a8380670614e3cc15112bd8b5b551c6d3a46f` and eight links. The archive proof separately preserves the immutable 31-record/202-link base; no remote/live, CI/FIFO, or ignored-workspace claim is made. |
...
postflight evidence in `9c18910`. Four eligible batches remain. ACER-004
through ACER-006 remain Queued. No later migration batch, helper-role
...
| N/A — ACER-003 shares the Plan linked in ACER-001 | In Progress. | Batch `ACER-003-001` in logical commit `28b42e7` retains its independently approved two-record/16-link evidence and rollback parent `90d496e4e96c172785eb23071173a7751e688fd1`. Batch `ACER-003-002` in logical commit `9c18910` removes the exact Spec 032 Plan/Task pair, preserves both payloads byte-for-byte in completed-lineage envelopes, repairs six current Markdown consumers, and records rollback parent `b390d54cab5c4b94960878f8d7f4fd887d18a132`. Eight focused tests, the exact 17-case self-test, production `2/4/35/233/4/7`, archive aggregate `35/233/35`, generic archive suites, the 21-test cutover regression, strict registry/Markdown/cross-document lanes, and the clean-tree repository aggregate pass while retaining the immutable `31/202` base proof. Requirements review was `REQUIREMENTS COMPLIANT`; quality review was `QUALITY APPROVED`; findings were none. Four eligible batches remain, so ACER-003 is not Done. |
