...
Three eligible lineage batches remain. ACER-004 through ACER-006 remain Queued.
...
| ACER-003 | VAL-ACER-002, VAL-ACER-006 | Migrate eligible execution records in atomic per-lineage full-body archive batches. | platform | In Progress | Batches `ACER-003-001` through `ACER-003-003` migrated the first three deterministic eligible pairs in independently approved logical commits `28b42e7`, `9c18910`, and `96176a9`. Three eligible batches remain, so ACER-003 is not Done. | The committed two-batch canonical prefix retains SHA-256 `07a94683e8980ab6c7a39e183826fe8c56cc0ff3a3d173327935eafead478364`. Batch 3 RED changed only the focused contract: the old two-batch validator rejected the exact proposed third prefix with `MIGRATION-ELIGIBLE-PREFIX`; 10 tests exited 1 with two failures and two errors. GREEN and clean-tree postflight pass 10 focused tests, the exact 20-case self-test, production migration `3/6/37/275/6/8`, generic archive recovery 15 tests, generic archive validation 22 tests, full archive cutover regression 21 tests, production archive `37/275/37`, strict registry/Markdown/cross-document validation, and the repository aggregate. Requirements re-review was `REQUIREMENTS COMPLIANT`; quality review was `QUALITY APPROVED`; findings were none after the archive-index prose correction. The third rollback parent is `22ad025ed7beb0725095d1ab413a2d5c49f8561c`; five batch-3 consumers are repaired. The Plan payload is 51,960 bytes with SHA-256 `102ffdabc9e0b839c449f00dd511355bd857ce49f8c423ffd8cfcef8491ffdcc` and 25 historical links; the Task payload is 8,415 bytes with SHA-256 `717c445c3b51db3ef286f342ad3a997063285fc170afe214af306cc0d8d48381` and 17 links. The archive proof separately preserves the immutable 31-record/202-link base; no remote/live, CI/FIFO, or ignored-workspace claim is made. |
...
and clean-tree postflight evidence in `96176a9`. Three eligible batches remain.
ACER-004 through ACER-006 remain Queued. No later migration batch, helper-role
