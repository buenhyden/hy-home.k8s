...
atomic lineage migration implemented and locally validated, while independent
review and the required logical commit remain pending. ACER-004 through
ACER-006 remain Queued. Produced evidence is recorded below.
...
| ACER-003 | VAL-ACER-002, VAL-ACER-006 | Migrate eligible execution records in atomic per-lineage full-body archive batches. | platform | In Progress | Batch `ACER-003-001` implements the first deterministic eligible pair, `2026-07-12-affected-surface-agent-qa`, as two exact completed-lineage archive records. Source removal, six current-consumer repairs, closed migration evidence, aggregate index projection, rollback-parent evidence, and local validation are present; independent review and one logical commit remain pending, so ACER-003 is not Done. | RED: six focused tests failed because the validator was absent. GREEN: six focused tests, the exact 13-case self-test, production migration validation, and archive cutover validation pass. The ledger records one complete batch/two records, rollback parent `90d496e4e96c172785eb23071173a7751e688fd1`, immutable ACER-001/002 inputs, two byte-exact source identities, six repaired consumers, and aggregate archive totals of 33 records/218 historical links; the archive proof separately preserves the exact immutable 31-record/202-link base. The Plan payload is 32,887 bytes with SHA-256 `114c1657b29b2a65ec7fe2bdbe80560141e72ccf75bc72c49d1e8bca739d55f2` and six links; the Task payload is 23,460 bytes with SHA-256 `fe8c79bc62deda32ff9f91a005f4aa879179fcc6548c57d43a351a424a507017` and ten links. No batch commit, review, remote/live, CI/FIFO, or ignored-workspace claim is made. |
...
claimed. ACER-002 is Done. ACER-003 has one implementation proposal with local
RED/GREEN, exact archive, rollback, consumer-repair, and aggregate-corpus
evidence; independent review and its logical commit remain pending. ACER-004
