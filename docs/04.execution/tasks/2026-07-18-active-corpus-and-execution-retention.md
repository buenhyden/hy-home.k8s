...
committed as `20cb1ca`; its fifth is independently approved and committed as
`52d4c2b`. One eligible lineage batch remains. ACER-004 through ACER-006 remain
Queued.
...
| ACER-003 | VAL-ACER-002, VAL-ACER-006 | Migrate eligible execution records in atomic per-lineage full-body archive batches. | platform | In Progress | Batches `ACER-003-001` through `ACER-003-005` migrated the first five deterministic eligible pairs in independently approved logical commits `28b42e7`, `9c18910`, `96176a9`, `20cb1ca`, and `52d4c2b`. One eligible batch remains, so ACER-003 is not Done. | The committed four-batch canonical prefix retains SHA-256 `94c5f43069ccc2847aa53b2d8aa8e7e9ebc89eadee5327530ba17ef5547b7abe`. Batch 5 RED proved the old four-batch validator rejects the proposed fifth prefix with `MIGRATION-ELIGIBLE-PREFIX`. GREEN and clean-tree postflight pass 13 focused tests, the exact 28-case self-test, production migration `5/10/41/329/10/13`, generic archive recovery and validation 37 tests, full archive cutover regression 21 tests, production archive `41/329/41`, strict registry/Markdown/cross-document validation, and the repository aggregate. Applicable changed-path pre-commit passed after the direct aggregate independently passed; hardcoded-secret and detect-secrets hooks passed and scanner configuration remained unchanged. A staged-only review exposed that batch 4 had legitimately named the now-retired Spec 035 Plan/Task as repaired consumers; the implementer-owned correction admits repaired consumers only when they remain current or are exact `originalPath` members of the already validated migration ledger, and a focused regression proves staged retirement acceptance plus missing non-migrated and arbitrary rogue-consumer rejection. Fresh requirements re-review was `REQUIREMENTS COMPLIANT`; final quality review was `QUALITY APPROVED`; findings were none after the corrections. The fifth rollback parent is `4de4c3e9ddb44949157399a1c71de788511d8a56`; five batch-5 consumers are repaired without changing the Spec index, WEIA, successor Spec 036 Plan, or generic Stage 90 index. The Plan payload is 33,047 bytes with SHA-256 `21196dd188f3d5400b65ccd8b8d837f7209a6f34b901d2082a5c9d0de5db1d9d` and 8 historical links; the Task payload is 26,367 bytes with SHA-256 `2e3ad60792196d7918e7909f9bb8e275194f0100922cd1f767cf779f906d7b08` and 14 links. Remote/live, CI/FIFO, and ignored-workspace evidence remain unclaimed. The archive proof separately preserves the immutable 31-record/202-link base. This Task evidence update commit is not identified or claimed. |
...
and quality approval, and clean-tree postflight evidence in `52d4c2b`.
...
| N/A — ACER-003 shares the Plan linked in ACER-001 | In Progress. | Batches `ACER-003-001` through `ACER-003-005` retain independently approved exact evidence in logical commits `28b42e7`, `9c18910`, `96176a9`, `20cb1ca`, and `52d4c2b`; the first four form the pinned SHA-256 prefix `94c5f43069ccc2847aa53b2d8aa8e7e9ebc89eadee5327530ba17ef5547b7abe`. Batch 5 removes the Spec 035 Plan/Task pair, preserves both payloads byte-for-byte in completed-lineage envelopes, repairs five current Markdown consumers, and records rollback parent `4de4c3e9ddb44949157399a1c71de788511d8a56`. Thirteen focused tests, the exact 28-case self-test, production `5/10/41/329/10/13`, archive aggregate `41/329/41`, generic archive suites, the 21-test cutover regression, strict registry/Markdown/cross-document lanes, applicable changed-path pre-commit, and the clean-tree repository aggregate pass while retaining the immutable `31/202` base proof. The staged-retirement regression admits only repaired consumers that remain current or are exact validated migration originals and rejects missing non-migrated and rogue consumers. Fresh requirements re-review was `REQUIREMENTS COMPLIANT`; final quality review was `QUALITY APPROVED`; findings were none after correction. One eligible batch remains, so ACER-003 is not Done. This Task evidence update commit is not identified or claimed. |
