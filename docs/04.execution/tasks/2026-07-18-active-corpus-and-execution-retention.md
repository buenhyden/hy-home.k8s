...
`9c18910`; its third is independently approved and committed as `96176a9`.
Its exact fourth atomic lineage migration is independently approved and
committed as `20cb1ca`. Its exact fifth atomic lineage migration is locally
GREEN and awaits independent review and one logical commit. One eligible
lineage batch remains. ACER-004 through ACER-006 remain Queued.
...
| ACER-003 | VAL-ACER-002, VAL-ACER-006 | Migrate eligible execution records in atomic per-lineage full-body archive batches. | platform | In Progress | Batches `ACER-003-001` through `ACER-003-004` migrated the first four deterministic eligible pairs in independently approved logical commits `28b42e7`, `9c18910`, `96176a9`, and `20cb1ca`. Exact batch `ACER-003-005` is locally GREEN and pending independent review and one logical commit. One eligible batch remains, so ACER-003 is not Done. | The committed four-batch canonical prefix retains SHA-256 `94c5f43069ccc2847aa53b2d8aa8e7e9ebc89eadee5327530ba17ef5547b7abe`. Batch 5 RED proved the old four-batch validator rejects the proposed fifth prefix with `MIGRATION-ELIGIBLE-PREFIX`. GREEN passes 13 focused tests, the exact 28-case self-test, production migration `5/10/41/329/10/13`, generic archive recovery and validation 37 tests, full archive cutover regression 21 tests, production archive `41/329/41`, strict registry/Markdown/cross-document validation, the direct working-tree repository aggregate, and applicable changed-path pre-commit after the direct aggregate independently passed; hardcoded-secret and detect-secrets hooks passed and scanner configuration remained unchanged. A staged-only review exposed that batch 4 had legitimately named the now-retired Spec 035 Plan/Task as repaired consumers; the implementer-owned correction admits repaired consumers only when they remain current or are exact `originalPath` members of the already validated migration ledger, and a focused regression proves both staged retirement acceptance and arbitrary missing-consumer rejection. The fifth rollback parent is `4de4c3e9ddb44949157399a1c71de788511d8a56`; five batch-5 consumers are repaired without changing the Spec index, WEIA, successor Spec 036 Plan, or generic Stage 90 index. The Plan payload is 33,047 bytes with SHA-256 `21196dd188f3d5400b65ccd8b8d837f7209a6f34b901d2082a5c9d0de5db1d9d` and 8 historical links; the Task payload is 26,367 bytes with SHA-256 `2e3ad60792196d7918e7909f9bb8e275194f0100922cd1f767cf779f906d7b08` and 14 links. Independent review, batch commit, clean-tree postflight, remote/live, CI/FIFO, and ignored-workspace evidence remain unclaimed. The archive proof separately preserves the immutable 31-record/202-link base. |
...
`20cb1ca`. Exact batch `ACER-003-005` has local RED/GREEN, byte-preserved
archive, rollback, five-consumer repair, aggregate-corpus, direct working-tree
repository aggregate PASS, and applicable changed-path pre-commit PASS;
independent review, its logical commit, and clean-tree postflight are pending.
One eligible batch remains. ACER-004 through ACER-006 remain Queued. No later
committed migration batch, helper-role
remediation, tranche closure, remote, live, or CI/FIFO result is claimed.
...
| N/A — ACER-003 shares the Plan linked in ACER-001 | In Progress. | Batches `ACER-003-001` through `ACER-003-004` retain their independently approved exact evidence in logical commits `28b42e7`, `9c18910`, `96176a9`, and `20cb1ca`; their canonical combined prefix is pinned to SHA-256 `94c5f43069ccc2847aa53b2d8aa8e7e9ebc89eadee5327530ba17ef5547b7abe`. Exact batch `ACER-003-005` removes the Spec 035 Plan/Task pair in the local proposal, preserves both payloads byte-for-byte in completed-lineage envelopes, repairs five current Markdown consumers, and records rollback parent `4de4c3e9ddb44949157399a1c71de788511d8a56`. Thirteen focused tests, the exact 28-case self-test, production `5/10/41/329/10/13`, archive aggregate `41/329/41`, generic archive suites, the 21-test cutover regression, strict registry/Markdown/cross-document lanes, the direct working-tree repository aggregate, and applicable changed-path pre-commit pass while retaining the immutable `31/202` base proof. The staged-retirement regression admits only repaired consumers that remain current or are exact validated migration originals and rejects a rogue missing consumer. Independent review, the batch-5 logical commit, and clean-tree postflight remain pending; one eligible batch remains, so ACER-003 is not Done. |
