...
ACER-003 through ACER-006 Queued until each package has its own RED/GREEN
evidence, independent reviews, and logical commit. ACER-001 is complete in
content logical commit `46b79fc`; ACER-002 is complete in content logical commit
`414905c`. Their postflight evidence is recorded below.
