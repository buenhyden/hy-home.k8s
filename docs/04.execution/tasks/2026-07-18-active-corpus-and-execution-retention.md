...
committed as `20cb1ca`. Two eligible lineage batches remain. ACER-004 through
ACER-006 remain Queued.
...
`20cb1ca`. Two eligible batches remain.
...
| N/A — ACER-003 shares the Plan linked in ACER-001 | In Progress. | Batches `ACER-003-001` through `ACER-003-003` retain their independently approved exact evidence in logical commits `28b42e7`, `9c18910`, and `96176a9`; their canonical combined prefix is pinned to SHA-256 `4269561e827a7a78f0d511d7db829aec72ed806fec831a3030e04f7dab70a27b`. Exact batch `ACER-003-004` in logical commit `20cb1ca` removes the Spec 034 Plan/Task pair, preserves both payloads byte-for-byte in completed-lineage envelopes, repairs six current Markdown consumers, and records rollback parent `fdb65db785a4518836ddf22a102b30eb7c9c1d61`. Eleven focused tests, the exact 24-case self-test, production `4/8/39/307/8/11`, archive aggregate `39/307/39`, generic archive suites, the 21-test cutover regression, strict registry/Markdown/cross-document lanes, and the clean-tree repository aggregate pass while retaining the immutable `31/202` base proof. Requirements review was `REQUIREMENTS COMPLIANT`; quality review was `QUALITY APPROVED`; findings were none. Two eligible batches remain, so ACER-003 is not Done. |
