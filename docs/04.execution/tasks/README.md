...
| [`./2026-08-07-document-taxonomy-consolidation.md`](./2026-08-07-document-taxonomy-consolidation.md) | [Spec 052](../../03.specs/052-document-taxonomy-consolidation/spec.md)와 reciprocal [Plan](../plans/2026-08-07-document-taxonomy-consolidation.md)의 WORK-000–WORK-015 실행 증거, 자산별 감축 delta, archive 불가침 증명, 독립 검토 처분을 추적한다. WORK-000 activation이 진행 중이며 후속 rows는 queued 상태다. | Active | 2026-08-07 |
