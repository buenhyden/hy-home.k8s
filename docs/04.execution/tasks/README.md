...
| [`./2026-07-22-reference-information-architecture.md`](./2026-07-22-reference-information-architecture.md) | [Spec 038](../../03.specs/038-reference-information-architecture/spec.md)과 reciprocal [Plan](../plans/2026-07-22-reference-information-architecture.md)의 RIA-000~006 exact commit·test·gate·package-review 결과와 six lifecycle paths plus registry state의 RIA-007 C1 exact-seven proposal을 추적한다. Ledger/contract은 C1에서 변경하지 않았고, whole-tranche review와 C1/C2/C3 identity·postflight·transition·settlement은 pending·unclaimed이다. | Done | 2026-07-26 |
