...
| [`./2026-07-18-active-corpus-and-execution-retention.md`](./2026-07-18-active-corpus-and-execution-retention.md) | [Spec 037](../../03.specs/037-active-corpus-and-execution-retention/spec.md)과 reciprocal [Plan](../plans/2026-07-18-active-corpus-and-execution-retention.md)의 ACER-001~006 결과를 추적한다. ACER-006 exact local staged QA와 distinct requirements/quality review는 관측 완료됐다. closure commit과 clean-tree post-commit/postflight만 pending·unclaimed이며 remote/live/CI/FIFO PASS는 주장하지 않는다. | Done | 2026-07-19 |
