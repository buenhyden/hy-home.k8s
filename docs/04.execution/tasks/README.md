...
| [`./2026-07-22-reference-information-architecture.md`](./2026-07-22-reference-information-architecture.md) | [Spec 038](../../03.specs/038-reference-information-architecture/spec.md)과 reciprocal [Plan](../plans/2026-07-22-reference-information-architecture.md)의 RIA-000~007 activation, contract, immutable audit/research observation, projection overlay, source scope/freshness, generation, duplicate-owner, aggregate·closure evidence를 추적한다. Plan-only RED, focused GREEN, reviewed active-control prerequisite, `active_controls=2/1`, changed/all-files QA PASS, requirements compliance, quality approval이 관찰됐으며 activation commit은 pending이고 RIA-001~007은 Queued다. | Active | 2026-07-22 |
