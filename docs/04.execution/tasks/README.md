...
| [`./2026-07-06-observability-and-network-review-agents.md`](./2026-07-06-observability-and-network-review-agents.md)                 | Task evidence for adding `observability-reviewer` and `network-reviewer` worker agents across three provider adapters and the harness catalog.                                                                                                                          | Draft | 2026-07-06 |
