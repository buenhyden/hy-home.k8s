...
| [`./2026-07-29-agent-harness-loop-lifecycle.md`](./2026-07-29-agent-harness-loop-lifecycle.md) | [Spec 043](../../03.specs/043-agent-harness-loop-lifecycle/spec.md)과 reciprocal [Plan](../plans/2026-07-29-agent-harness-loop-lifecycle.md)의 AHLL-000~004를 추적한다. Exact-eight activation proposal은 in progress이며 loop/checkpoint/memory lifecycle 구현, QA, review, closure, postflight evidence는 아직 관찰되지 않았다. | Active | 2026-07-29 |
