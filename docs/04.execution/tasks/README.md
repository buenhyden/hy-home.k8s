...
| [`./2026-07-28-stage-00-agent-governance-contract.md`](./2026-07-28-stage-00-agent-governance-contract.md) | [Spec 041](../../03.specs/041-stage-00-agent-governance-contract/spec.md)과 reciprocal [Plan](../plans/2026-07-28-stage-00-agent-governance-contract.md)의 SAGC-000~005 결과를 추적한다. Activation, closed schema/fixtures, current 10/30과 target-only 12/48, 네 memory class, consumer migration, routing, QA/review/closure가 범위이며 provider/runtime/hosted/remote/live는 `DEFER`다. | Active | 2026-07-28 |
