...
| [`./2026-08-01-agent-governance-program-closure.md`](./2026-08-01-agent-governance-program-closure.md) | [Spec 046](../../03.specs/046-agent-governance-program-closure/spec.md)과 reciprocal [Plan](../plans/2026-08-01-agent-governance-program-closure.md)의 AGPC-000~005 실행을 추적한다. 현재 AGPC-000 활성화가 진행 중이며, closure contract 구현과 provider/hosted/actual/remote/live lane 분리는 후속 작업으로 남아 있다. | Active | 2026-08-01 |
