...
7. 현재 구현과 상충하거나 superseded-only인 old Task는 full-body Archive Record로 보존하고 `../../98.archive/README.md`에만 인덱싱하며, 활성 Task에서 개별 record에 직접 연결하지 않는다.
...
| [`./2026-06-02-current-implementation-docs-alignment.md`](./2026-06-02-current-implementation-docs-alignment.md)                     | 현재 구현 기준 01-04 문서 정렬, central archive corpus 전환, QA/CI gate 보강 증적                                                                                                                                                                                    | Done | 2026-06-02 |
...
| [`./2026-07-18-active-corpus-and-execution-retention.md`](./2026-07-18-active-corpus-and-execution-retention.md) | [Spec 037](../../03.specs/037-active-corpus-and-execution-retention/spec.md)과 reciprocal [Plan](../plans/2026-07-18-active-corpus-and-execution-retention.md)의 ACER-001~006 결과를 추적한다. closure content commit `cfabc506`, final terminal requirements/quality approval, clean-tree postflight PASS를 관측했다. evidence-update commit 자체와 remote/live/CI/FIFO PASS는 주장하지 않는다. | Done | 2026-07-19 |
| [`./2026-07-22-reference-information-architecture.md`](./2026-07-22-reference-information-architecture.md) | [Spec 038](../../03.specs/038-reference-information-architecture/spec.md)과 reciprocal [Plan](../plans/2026-07-22-reference-information-architecture.md)의 RIA-000~006 결과 및 RIA-007 C1 exact-seven commit `8c0dcea558212e11ac93a0fe626cddb31315859b`을 추적한다. C1 final review는 `REQUIREMENTS COMPLIANT`/`QUALITY APPROVED`, activation-to-C1 explicit-ref lifecycle과 repository-static clean-tree postflight는 PASS였다. 현재 C2 exact-nine은 six lifecycle paths, 446-row ledger, contract, exact-value `.secrets.baseline` adjudication의 staged proposal이며 C2 SHA/postcommit, C3, settlement, terminal explicit-ref, CI-hosted/provider/remote/live 결과는 unclaimed다. | Done | 2026-07-26 |
| [`./2026-07-26-github-ci-qa-evidence.md`](./2026-07-26-github-ci-qa-evidence.md) | [Spec 039](../../03.specs/039-github-ci-qa-evidence/spec.md)과 reciprocal [Plan](../plans/2026-07-26-github-ci-qa-evidence.md)의 GCQE-000~006 결과를 추적한다. Exact eight-path closure `e1d1e910840337327a557ab4b84e86f8fced11d6`, activation `2ddfe4b7697e998b41d3125be94cdc4cee295388`부터의 raw-OID explicit-ref lifecycle, clean-tree repository-static postflight는 PASS였다. Hosted run `29982910320`은 historical FAIL이고 current hosted/provider/live는 `DEFER`이며, 이 evidence-update commit 자체는 주장하지 않는다. | Done | 2026-07-27 |
| [`./2026-07-27-contract-cutover-and-program-closure.md`](./2026-07-27-contract-cutover-and-program-closure.md) | [Spec 040](../../03.specs/040-contract-cutover-and-program-closure/spec.md)과 reciprocal [Plan](../plans/2026-07-27-contract-cutover-and-program-closure.md)의 CCPC-000~004 repository-static 증거를 추적한다. 2026-07-28 exact 14-path terminal closure commit `c5adc27b13893d7cbd1266c9225372cfb7df79e9`은 lifecycle `668`, strict/residue/aggregate/all-files/formatter/diff PASS, `0/0·6/3·3` frontier, reviewed digest `e146fb13fb3a62db014e6317992a4f519b79ba330253c4c5fe89834dc67e1888`, terminal requirements/quality/security approval, parent `35d8552ba423e3e2d92294ddeb81674392b8f333`부터 closure까지 explicit-ref와 clean-tree aggregate PASS를 기록한다. Evidence-update commit 자체와 external lanes는 unclaimed/`DEFER`다. | Done | 2026-07-28 |
...
| [`./2026-08-02-current-surface-and-stash-reconciliation.md`](./2026-08-02-current-surface-and-stash-reconciliation.md) | [Spec 047](../../03.specs/047-current-surface-and-stash-reconciliation/spec.md)과 reciprocal [Plan](../plans/2026-08-02-current-surface-and-stash-reconciliation.md)의 program activation, target disposition, stash reconciliation, QA, and handoff evidence를 추적한다. PRD-007 실행 일시 중단에 따라 2026-08-07부터 draft로 되돌아갔고 모든 rows는 queued 상태로 유지된다. | Draft | 2026-08-07 |
...
| [`./2026-08-09-workspace-governance-audit-and-remediation.md`](./2026-08-09-workspace-governance-audit-and-remediation.md) | [Spec 054](../../03.specs/054-workspace-governance-audit-and-remediation/spec.md)와 reciprocal [Plan](../plans/2026-08-09-workspace-governance-audit-and-remediation.md)의 WGIA-000–014 감사, canonical-owner remediation, RIA Current cutover, 증거 기반 cleanup, review와 lifecycle closure evidence를 추적한다. | Active | 2026-08-09 |
