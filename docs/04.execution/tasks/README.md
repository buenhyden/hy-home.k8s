...
| [`./2026-07-05-workspace-contract-governance-normalization.md`](./2026-07-05-workspace-contract-governance-normalization.md) | `_workspace` staging, frontmatter/template drift, CI/CD와 QA control-surface baseline inventory를 추적하는 workspace contract governance normalization Task | Draft | 2026-07-05 |
