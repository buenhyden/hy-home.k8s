...
| [`./2026-08-07-document-taxonomy-consolidation.md`](./2026-08-07-document-taxonomy-consolidation.md) | [Spec 052](../../03.specs/052-document-taxonomy-consolidation/spec.md)와 reciprocal [Plan](../plans/2026-08-07-document-taxonomy-consolidation.md)의 WORK-100–WORK-110 실행·검증·Archive·review 증거를 추적한다. 전체 설계와 구현 계획이 승인됐으며 모든 work row는 실행 전 queued 상태다. | Active | 2026-08-09 |
