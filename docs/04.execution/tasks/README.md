...
| [`./2026-07-30-agent-governance-ci-qa-cutover.md`](./2026-07-30-agent-governance-ci-qa-cutover.md) | [Spec 045](../../03.specs/045-agent-governance-ci-qa-cutover/spec.md)과 reciprocal [Plan](../plans/2026-07-30-agent-governance-ci-qa-cutover.md)의 AGQC-000~006 실행 증거를 추적한다. AGQC-000~005는 `Done`이며 `CI and legacy-cutover contracts/validators/tests`, closed schemas/fixtures와 repository-static route가 구현됐다. AGQC-006은 whole-branch review/remediation/full-QA 단계에서 진행 중이고 reciprocal closure/postflight identity는 아직 주장하지 않는다. Hosted CI, branch protection, provider runtime/auth/model discovery, actual evaluation/admission/promotion, remote/live, provider resume/handoff canary는 `DEFER`다. | Active | 2026-07-30 |
