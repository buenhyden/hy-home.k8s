...
| [`./2026-07-03-template-governance-audit-enhancement.md`](./2026-07-03-template-governance-audit-enhancement.md) | template governance 후속 audit findings, support contract drift 정리, validator hardening, final validation evidence를 추적 | Draft | 2026-07-03 |
