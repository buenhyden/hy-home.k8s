...
| [`./2026-07-02-workspace-harness-implementation-audit-pack.md`](./2026-07-02-workspace-harness-implementation-audit-pack.md) | `docs/90.references/audits/` 구현 현황 감사 팩의 작성, benchmark-to-evidence 비교, automation opportunity, repo-static 검증 evidence를 추적 | Draft | 2026-07-02 |
