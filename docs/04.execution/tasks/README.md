...
| [`./2026-07-22-reference-information-architecture.md`](./2026-07-22-reference-information-architecture.md) | [Spec 038](../../03.specs/038-reference-information-architecture/spec.md)과 reciprocal [Plan](../plans/2026-07-22-reference-information-architecture.md)의 RIA-000~007 contract, code-owned Current root FSM, stage-zero authority, bounded transition/settlement lineage, source·generator·duplicate-owner·closure evidence를 추적한다. RIA-000은 `cb0c1f6`, RIA-001은 `68e46fc`·`566c74f`·`15bba3d`와 clean final review로 Completed다. RIA-002는 design correction review까지 In Progress이며 implementation RED는 시작하지 않았다. | Active | 2026-07-22 |
