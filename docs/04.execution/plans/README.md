...
| [`./2026-08-07-document-taxonomy-consolidation.md`](./2026-08-07-document-taxonomy-consolidation.md) | [Spec 052](../../03.specs/052-document-taxonomy-consolidation/spec.md)의 execution stage 폐지, work unit 통합, operations stage 재번호, 파일명 날짜 제거, lineage frontmatter, 규칙 문서 통합, machine contract 및 validator 감축 실행 계획이다. WDTC-000부터 WDTC-015까지 위험 오름차순 논리 커밋으로 진행하며 archive 불가침을 전 구간 제약으로 둔다. | Active | 2026-08-07 |
