...
| [`./2026-08-07-document-taxonomy-consolidation.md`](./2026-08-07-document-taxonomy-consolidation.md) | [Spec 052](../../03.specs/052-document-taxonomy-consolidation/spec.md)의 승인 방향을 11개 논리 커밋으로 실행한다. Stage 03 work-unit 통합과 Stage 04 폐지, Stage 05 유지와 Release 제외, 50개 고유 execution 기록 Archive, Stage 00/99 authority 통합, harness agent-system 통제, validator 의미 보존, 기준선·generated/memory 정리를 fail-closed 순서로 고정한다. | Active | 2026-08-09 |
