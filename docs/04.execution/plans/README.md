...
| [`./2026-07-04-agent-governance-contract-normalization.md`](./2026-07-04-agent-governance-contract-normalization.md) | Stage 00 agent governance, provider adapters, GitHub control surfaces, QA/CI validation gates를 provider-aware contract로 정규화하는 실행 계획 | Draft | 2026-07-04 |
