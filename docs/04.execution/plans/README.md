...
| [`./2026-05-28-docs-governance-consistency.md`](./2026-05-28-docs-governance-consistency.md)                   | 문서 거버넌스 일관성 정비 — templates, policies, runbooks, guides, plans/tasks 준수율 향상 및 레거시 파일 제거 계획                                                            | Active | 2026-05-28 |
