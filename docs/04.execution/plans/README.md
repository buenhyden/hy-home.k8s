...
| [`./2026-07-26-github-ci-qa-evidence.md`](./2026-07-26-github-ci-qa-evidence.md) | [Spec 039](../../03.specs/039-github-ci-qa-evidence/spec.md)의 GitHub CI, QA, all-files pre-commit, artifact-retention, result-vocabulary evidence implementation plan이다. Activation consumes prerequisite commit `cd726e0`; implementation, closure, hosted CI, and live/provider results remain pending. | Active | 2026-07-26 |
