...
| [`./2026-07-29-agent-roster-evaluation-and-admission.md`](./2026-07-29-agent-roster-evaluation-and-admission.md) | [Spec 044](../../03.specs/044-agent-roster-evaluation-and-admission/spec.md)의 AREA-000~005를 실행한다. AREA-002는 exact 12-role/4-surface/48-adapter tracked projection을 `DEFER` admission으로 만들고, AREA-003은 final admission에 필요한 eval/adjudication/rollback을 소유한다. Provider runtime/live와 model resolution은 관찰 전까지 `DEFER`다. | Active | 2026-07-29 |
