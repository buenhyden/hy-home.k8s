...
| [`./2026-07-16-document-schema-and-lifecycle-contract.md`](./2026-07-16-document-schema-and-lifecycle-contract.md) | Active DSLC-001 through DSLC-006 plan for registry v7 values, role decisions, lifecycle comparison, evidence predicates, template/native parity, bounded drift remediation, and Spec 035 closure. | Active | 2026-07-16 |
