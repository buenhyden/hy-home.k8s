...
| [`./2026-07-28-provider-native-runtime-and-model-evidence.md`](./2026-07-28-provider-native-runtime-and-model-evidence.md) | [Spec 042](../../03.specs/042-provider-native-runtime-and-model-evidence/spec.md)의 provider-native runtime/model evidence tranche를 활성화하고 cutoff source ledger, provider-local observation, model/effort 후보, canary record, secret-free runtime boundary를 검증한다. | Active | 2026-07-28 |
