...
3. Plan 변경 시 관련 `04.execution/tasks/`의 Parent Plan/Phase 링크를 확인한다.
...
- `03.specs/`: 계획의 입력이 되는 기술 명세
- `04.execution/tasks/`: 계획을 실행 가능한 작업으로 나눈 기록
- `05.operations/policies/`: 롤아웃과 운영 정책 기준
