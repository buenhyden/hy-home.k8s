...
| [`./2026-08-01-agent-governance-program-closure.md`](./2026-08-01-agent-governance-program-closure.md) | [Spec 046](../../03.specs/046-agent-governance-program-closure/spec.md)의 repository-local program closure 실행 계획이다. Spec 045 closure `de9a88e4`와 postflight `06039611` 이후 closure contract, validator, QA routing, 네 memory class, model/reasoning 구성 정합성, independent review, reciprocal closure를 수행하며 provider/hosted/actual/remote/live lane은 별도 승인 없이는 `DEFER`다. | Active | 2026-08-01 |
