...
| [`./2026-07-29-agent-harness-loop-lifecycle.md`](./2026-07-29-agent-harness-loop-lifecycle.md) | [Spec 043](../../03.specs/043-agent-harness-loop-lifecycle/spec.md)의 AHLL-000~004를 exact retry/recovery ceiling → checkpoint/resume와 memory lifecycle → routing/provider integration → QA/review/closure 순서로 실행한다. Repository state가 resume conflict에서 우선하며 runtime implementation은 아직 주장하지 않는다. | Active | 2026-07-29 |
