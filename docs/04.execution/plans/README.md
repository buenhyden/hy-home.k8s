...
| [`./2026-08-11-workspace-engineering-partial-defer-incremental-refresh.md`](./2026-08-11-workspace-engineering-partial-defer-incremental-refresh.md) | 승인된 [Spec 056](../../03.specs/056-workspace-engineering-partial-defer-incremental-refresh/spec.md)의 12개 기본 `Partial` 및 조건부 qualified `DEFER`를 폐쇄형 Gap Ledger로 심사하고, 공식 소스·워크스페이스 정적 근거·읽기 전용 GitHub Actions/settings 메타데이터만 기존 `2026-08-08-wer` 팩에 증분 통합하는 실행 계획이다. | Draft | 2026-08-11 |
