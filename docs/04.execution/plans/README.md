...
| [`./2026-07-04-workspace-engineering-research-pack.md`](./2026-07-04-workspace-engineering-research-pack.md) | `docs/90.references/research/2026-07-04-wer/` 아래 dated research pack을 만들고 기존 4개 reference를 재배치하며 Kubernetes, infrastructure, security, automation, pipeline, workflow, QA 주제를 보강하는 실행 계획 | Draft | 2026-07-04 |
