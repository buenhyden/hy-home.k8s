...
| [`./2026-07-02-workspace-harness-research-pack.md`](./2026-07-02-workspace-harness-research-pack.md) | `docs/90.references/research/` 통합 연구 팩 작성, 공식 외부 소스 우선 조사, market scan, implementation checklist, 검증 증적을 묶는 실행 계획 | Draft | 2026-07-02 |
