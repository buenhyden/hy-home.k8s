...
| [`./2026-07-18-active-corpus-and-execution-retention.md`](./2026-07-18-active-corpus-and-execution-retention.md) | [Spec 037](../../03.specs/037-active-corpus-and-execution-retention/spec.md)의 ACER-001~005 reviewed 결과와 ACER-006 terminal staged-closure proposal을 기록한다. reciprocal pair는 active authority가 아닌 terminal Stage 04 `DEFER` evidence이며 closure commit과 clean-tree post-commit은 pending이다. | Done | 2026-07-19 |
