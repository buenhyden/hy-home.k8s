...
| [`./2026-07-04-workspace-document-contract-normalization.md`](./2026-07-04-workspace-document-contract-normalization.md) | active 문서와 historical evidence를 current frontmatter, section, template, CI/QA, validator 계약에 맞게 전면 정규화하는 실행 계획 | Draft | 2026-07-04 |
