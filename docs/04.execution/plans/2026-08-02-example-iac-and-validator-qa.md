...
[Spec 050](../../03.specs/050-example-iac-and-validator-qa/spec.md) consumes
...
- **Task**: [Example IaC and Validator QA Task](../tasks/2026-08-02-example-iac-and-validator-qa.md)
...
| --- | --- | --- |
| [VAL-EIVQ-001](../../03.specs/050-example-iac-and-validator-qa/spec.md#success-criteria--verification-plan) | EIVQ-001, EIVQ-002 | [Closed contract/argv/tool/root mutation evidence](../tasks/2026-08-02-example-iac-and-validator-qa.md#task-table) |
| N/A — VAL-EIVQ-002 and VAL-EIVQ-003 share the Spec source above | EIVQ-003 | [Exact Terraform, provider lock, native result, and artifact evidence](../tasks/2026-08-02-example-iac-and-validator-qa.md#task-table) |
| N/A — VAL-EIVQ-004 shares the Spec source above | EIVQ-004 | [Per-source Bicep lint/build/warning evidence](../tasks/2026-08-02-example-iac-and-validator-qa.md#task-table) |
| N/A — VAL-EIVQ-005 shares the Spec source above | EIVQ-001, EIVQ-002 | [Focused negative/fallback regression evidence](../tasks/2026-08-02-example-iac-and-validator-qa.md#task-table) |
| N/A — VAL-EIVQ-006 and VAL-EIVQ-007 share the Spec source above | EIVQ-004, EIVQ-005 | [README, placeholder, redaction, and protected-boundary evidence](../tasks/2026-08-02-example-iac-and-validator-qa.md#task-table) |
| N/A — VAL-EIVQ-008 shares the Spec source above | EIVQ-005, EIVQ-006 | [Routing, CI, QA, review, and closure evidence](../tasks/2026-08-02-example-iac-and-validator-qa.md#task-table) |
