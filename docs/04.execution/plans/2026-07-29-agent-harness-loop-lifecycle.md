...
- **Task**: [Agent Harness Loop Lifecycle Task](../tasks/2026-07-29-agent-harness-loop-lifecycle.md)
...
| --- | --- | --- |
| [VAL-AHLL-001](../../03.specs/043-agent-harness-loop-lifecycle/spec.md#success-criteria--verification-plan) | AHLL-000, AHLL-001 | [Activation and retry-ceiling evidence](../tasks/2026-07-29-agent-harness-loop-lifecycle.md#task-table) |
