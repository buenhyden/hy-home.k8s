...
- **Operability**: bootstrap-local.sh에서 rootCA 주입 단계 추가. 문서 체인(01~09) 추적성 유지.
...
- **ADR**: [`../03.adr/0006-cert-manager-mkcert-ca-issuer.md`](../03.adr/0006-cert-manager-mkcert-ca-issuer.md)
- **ADR**: [`../03.adr/0007-kubernetes-dashboard-v3.md`](../03.adr/0007-kubernetes-dashboard-v3.md)
- **ADR**: [`../03.adr/0008-istio-install-and-ingress-coexist.md`](../03.adr/0008-istio-install-and-ingress-coexist.md)
- **ADR**: [`../03.adr/0009-kiali-external-observability.md`](../03.adr/0009-kiali-external-observability.md)
