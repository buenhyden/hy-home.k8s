...
| ---- | ----------- | -------------- | ---------- | ------------------- |
| TASK-001 | Audit root instruction files against existing `.claude/` guidance and identify root-only essentials | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.claude/index.md`, `.claude/governance.md`, `.claude/repo-navigation.md`, `.claude/rules/core.md`, `.claude/rules/docs-map.md`, `.claude/rules/personas.md`, `.claude/rules/repo-navigation.md` | REQ-001 | Duplication and missing cross-links identified from inspected files only |
