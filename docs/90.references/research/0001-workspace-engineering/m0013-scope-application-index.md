...
| [qa](../../../../.agents/roles/quality.md)                     | `REQ-WERPC-023`, `REQ-WERPC-024`, `REQ-WERPC-029`, `REQ-WERPC-033`                                                  | `scripts/validate-*.py`, `docs/00.agent-governance/contracts/`, `tests/`                                                 | [GitHub Actions baseline](m0008-ci-cd-github-actions-and-qa.md#github-actions-baseline), [QA baseline](m0008-ci-cd-github-actions-and-qa.md#qa-baseline), [Verification and Validation matrix](m0008-ci-cd-github-actions-and-qa.md#verification-and-validation-question-matrix)                                                                                                                                                                                                                                                                                                                  | `REQ-WERPC-023`, `REQ-WERPC-033` `Partial`                                                    | Hosted runs, rulesets, secrets, environments, OIDC, artifacts, and intended-use evidence remain `DEFER`                                                                                     | Keep static `PASS` labelled as bounded conformance evidence. A green lane is verification, never validation of intended use                                                                                                                                                                                                                                 |
