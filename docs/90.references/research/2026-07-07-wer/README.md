...
| [document-migration-evidence-ledger.md](document-migration-evidence-ledger.md) | Current | 469개 대상 문서의 처분, 목적지, 로컬 증거, 외부 형식 근거 및 freshness 경계 | 마이그레이션 증적 정본; 원문 사실, accepted ADR, 프로바이더 명세, 런타임 상태의 권한을 대체하지 않음 |
