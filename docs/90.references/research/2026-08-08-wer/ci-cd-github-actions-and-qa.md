...
deployment/publishing, cloud identity, remote GitOps, and live validation. All
external sources were checked on 2026-08-08; their version/product boundaries
and refresh triggers are retained in the ledger.
...
Attach a hosted run identity before reporting hosted CI `PASS`; attach a
separately approved bounded procedure before reporting remote/live `PASS`.
