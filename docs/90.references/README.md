...
| [data/active-corpus-eligibility-ledger.json](./data/active-corpus-eligibility-ledger.json) | repo-backed dry-run ledger | ACER-002 pinned eligibility, residue, consumer, archive-route, and recovery evidence; no archive mutation | ACER-003 cutover, pinned Git-object drift, or upstream evidence change |
| [data/active-corpus-migration-results.json](./data/active-corpus-migration-results.json) | repo-backed closed migration-result ledger | ACER-003 deterministic eligible-prefix batches, exact archive/source/digest/link evidence, repaired consumers, and rollback parents | Each ACER-003 batch, archive/index/consumer drift, validation result, or rollback boundary change |
| [data/active-corpus-role-audit.json](./data/active-corpus-role-audit.json) | repo-backed closed role-audit ledger | ACER-004 Stage 05 authored-operation and helper Tests role separation, exact inventory closure, and zero findings | Stage 05/helper inventory or role change, README structure drift, or Spec 037 closure |
| [data/active-corpus-residue-closure.json](./data/active-corpus-residue-closure.json) | repo-backed closed post-cutover ledger | ACER-006 terminal proposal: 12 migrated-closed, 100 current `DEFER`/0 `retain`, 48/1/3 cardinality, 13 accepted ADR and 29 done-Spec guards, and zero findings | Exact successor migration evidence, current inventory/authority, migration/archive, ACER-004 input, strict link evidence, or post-commit closure evidence change |
...
새 reference 문서는 [reference.template.md](../99.templates/templates/references/reference.template.md)의 필수 heading을 유지한다.
