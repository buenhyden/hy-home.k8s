...
| [data/active-corpus-residue-closure.json](./data/active-corpus-residue-closure.json) | repo-backed closed post-cutover ledger | ACER-005 exact migration closure, bounded current DEFER/control authority, Plan/Task cardinality, accepted ADR/done-Spec guards, and zero final findings | Exact upstream evidence, current inventory/authority, migration/archive, ACER-004 input, strict link evidence, or Spec 037 closure change |
