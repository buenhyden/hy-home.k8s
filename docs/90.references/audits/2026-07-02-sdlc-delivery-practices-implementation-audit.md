...
- Uses `docs/90.references/research/spec-sdlc-ci-qa-formatting.md` as the
...
- [Spec SDLC CI QA Formatting Research](../research/spec-sdlc-ci-qa-formatting.md)
...
- **Research benchmark**: [Spec SDLC CI QA Formatting Research](../research/spec-sdlc-ci-qa-formatting.md)
