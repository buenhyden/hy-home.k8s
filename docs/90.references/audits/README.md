...
| [2026-08-09-wgia](./2026-08-09-wgia/README.md) | Current pack | Workspace governance implementation audit across purpose, SDLC, delivery, harness, agents, knowledge, security, and cleanup. | Completion evidence is in the [Plan](../../03.specs/0055-workspace-governance-audit-and-remediation/plan.md) and [Task](../../03.specs/0055-workspace-governance-audit-and-remediation/README.md). |
