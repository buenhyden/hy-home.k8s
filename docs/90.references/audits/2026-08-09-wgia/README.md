...
| REQ-WGA-006 | Harness engineering | [Harness engineering](harness-loop-fixtures-scripts-and-blockers.md#harness-engineering) | `docs/00.agent-governance/contracts/harness-contract.json`; `scripts/validate-harness.sh` | `repository-static` | `Partial` |
| REQ-WGA-007 | Loop engineering | [Loop engineering](harness-loop-fixtures-scripts-and-blockers.md#loop-engineering) | `docs/00.agent-governance/contracts/agent-loop-lifecycle.json`; `scripts/validate-agent-loop-lifecycle.py` | `repository-static` | `Partial` |
| REQ-WGA-008 | QA | [QA](ci-cd-github-actions-qa-and-validation.md#qa) | `docs/00.agent-governance/rules/quality-standards.md`; `tests/README.md` | `repository-static` | `Partial` |
...
| REQ-WGA-016 | Templates | [Templates](spec-driven-sdlc-documentation-and-templates.md#templates) | `docs/99.templates/templates/`; `docs/99.templates/support/template-routing.md` | `repository-static` | `Partial` |
| REQ-WGA-017 | Scripts | [Scripts](harness-loop-fixtures-scripts-and-blockers.md#scripts) | `scripts/README.md`; `scripts/` | `repository-static` | `Partial` |
| REQ-WGA-018 | Integration guides | [Integration guides](spec-driven-sdlc-documentation-and-templates.md#integration-guides) | `docs/05.operations/guides/README.md`; `docs/05.operations/guides/` | `repository-static` | `Partial` |
| REQ-WGA-019 | Documents and documentation | [Documents and documentation](spec-driven-sdlc-documentation-and-templates.md#documents-and-documentation) | `docs/99.templates/support/document-profiles.json`; `docs/README.md` | `repository-static` | `Partial` |
| REQ-WGA-020 | Verification | [Verification](ci-cd-github-actions-qa-and-validation.md#verification) | `docs/00.agent-governance/rules/quality-standards.md`; Spec 054 success criteria | `repository-static` | `Partial` |
| REQ-WGA-021 | Validation | [Validation](ci-cd-github-actions-qa-and-validation.md#validation) | `docs/00.agent-governance/contracts/validation-surfaces.json`; document validators | `repository-static` | `Partial` |
| REQ-WGA-022 | LLM-WIKI | [LLM-WIKI](llm-wiki-memory-and-knowledge-management.md#llm-wiki) | `docs/90.references/llm-wiki/`; `scripts/generate-llm-wiki-index.sh` | `repository-static` | `Partial` |
| REQ-WGA-023 | SDLC | [SDLC](spec-driven-sdlc-documentation-and-templates.md#sdlc) | `docs/01.requirements/` through `docs/05.operations/`; `docs/99.templates/support/sdlc-governance.md` | `repository-static` | `Partial` |
| REQ-WGA-024 | Security | [Security](security-and-approval-boundaries.md#security) | `docs/00.agent-governance/rules/approval-boundaries.md`; `.gitleaks.toml`; GitOps policy surfaces | `repository-static` | `Partial` |
| REQ-WGA-025 | Legacy and Deprecated documents | [Legacy and Deprecated documents](legacy-deprecated-and-one-shot-disposition-ledger.md#legacy-and-deprecated-documents) | `docs/99.templates/support/legacy-cleanup-rules.md`; `docs/00.agent-governance/contracts/agent-legacy-cutover.json` | `repository-static` | `Partial` |
| REQ-WGA-026 | One-shot documents and scripts | [One-shot documents and scripts](legacy-deprecated-and-one-shot-disposition-ledger.md#one-shot-documents-and-scripts) | tracked document/script inventory; current consumer surfaces | `repository-static` | `Partial` |
| REQ-WGA-027 | Memory tiers and management | [Memory tiers and management](llm-wiki-memory-and-knowledge-management.md#memory-tiers-and-management) | `docs/00.agent-governance/memory/README.md`; `docs/00.agent-governance/contracts/agent-checkpoint.schema.json` | `repository-static` | `Partial` |
| REQ-WGA-028 | AI Agents | [AI Agents](ai-agents-integrated-and-role-specific-agents.md#ai-agents) | `docs/00.agent-governance/contracts/harness-contract.json`; provider adapter roots | `repository-static` | `Partial` |
| REQ-WGA-029 | Integrated AI Agent | [Integrated AI Agent](ai-agents-integrated-and-role-specific-agents.md#integrated-ai-agent) | `docs/00.agent-governance/subagent-protocol.md`; supervisor adapter surfaces | `repository-static` | `Partial` |
| REQ-WGA-030 | Individual AI Agents | [Individual AI Agents](ai-agents-integrated-and-role-specific-agents.md#individual-ai-agents) | `docs/00.agent-governance/harness-catalog.md`; four tracked adapter roots | `repository-static` | `Partial` |
...
| [Legacy, Deprecated, and One-shot Disposition Ledger](legacy-deprecated-and-one-shot-disposition-ledger.md) | `draft` | Candidate and deletion-proof record shape; no deletion decision yet. |
| [Remediation and Integration Roadmap](remediation-and-integration-roadmap.md) | `draft` | Cross-report integration shape, dependencies, rollback, and residual backlog. |
