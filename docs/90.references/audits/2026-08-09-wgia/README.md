...
| REQ-WGA-017 | Scripts | [Scripts](harness-loop-fixtures-scripts-and-blockers.md#scripts) | `scripts/README.md`; `scripts/archive_cutover_manifest.py`; `scripts/reference_information_architecture.py`; `tests/README.md` | `repository-static` | `Partial` |
