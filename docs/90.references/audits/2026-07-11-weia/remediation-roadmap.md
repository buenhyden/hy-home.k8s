...
with completed Plan/Task evidence indexed through the [Archive
Index](../../../98.archive/README.md#document-index), provides the
repository-static owner chain.
