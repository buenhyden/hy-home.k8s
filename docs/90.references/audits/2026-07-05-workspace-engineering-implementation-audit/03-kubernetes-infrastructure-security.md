...
| supply-chain and image policy boundaries | Image and supply-chain controls should be explicit and not overclaim signatures, SBOMs, or provenance where absent. | Repo-quality and policy gates reject active `:latest` images; GitOps README documents active image policy and distinguishes future supply-chain topics. | Partial | [gitops image policy](../../../../gitops/README.md), [policy validator](../../../../scripts/validate-policy-gates.sh), [SDLC/CI/QA audit](02-sdlc-ci-qa-formatting-automation.md) | The repo does not currently prove image signatures, vulnerability status, SBOMs, SLSA provenance, or artifact attestation. | Route image signing, scanning, SBOM, provenance, or Scorecard gates to future CI/security specs and tasks. |
...
- [SDLC CI QA Automation Audit](02-sdlc-ci-qa-formatting-automation.md)
...
- **Kubernetes/infrastructure/security research**: [Kubernetes Infrastructure Security Research](../../research/2026-07-04-workspace-engineering-research-pack/kubernetes-infrastructure-security.md)
