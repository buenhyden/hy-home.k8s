...
- `active-corpus-role-audit.json` is ACER-004 repository-static evidence. It
  ...
  as 33 frozen plus two exact manifested RIA helpers. A supported extension or
