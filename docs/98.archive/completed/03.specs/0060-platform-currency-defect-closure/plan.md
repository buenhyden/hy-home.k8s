...
| --------------------------------------------------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------- |
| [VAL-PCDC-001](./spec.md) | PCDC-001      | [PCDC-001](./tasks/tsk-0001-pcdc-001.md) will record the ClusterRole parse and rule check |
| [VAL-PCDC-002](./spec.md) | PCDC-001      | [PCDC-001](./tasks/tsk-0001-pcdc-001.md) will record why endpointslices was excluded      |
| [VAL-PCDC-003](./spec.md) | PCDC-002      | [PCDC-002](./tasks/tsk-0002-pcdc-002.md) will record the pins and the shell syntax result |
| [VAL-PCDC-004](./spec.md) | PCDC-002      | [PCDC-002](./tasks/tsk-0002-pcdc-002.md) will record the script-to-contract comparison    |
| [VAL-PCDC-005](./spec.md) | PCDC-002      | [PCDC-002](./tasks/tsk-0002-pcdc-002.md) will record the upstream version evidence        |
| [VAL-PCDC-006](./spec.md) | PCDC-003      | [PCDC-003](./tasks/tsk-0003-pcdc-003.md) will record the decision and reversal condition  |
| [VAL-PCDC-007](./spec.md) | PCDC-003      | [PCDC-003](./tasks/tsk-0003-pcdc-003.md) will record the deferred upgrade table           |
| [VAL-PCDC-008](./spec.md) | PCDC-004      | [PCDC-004](./tasks/tsk-0004-pcdc-004.md) will record the full lane results                |
| [VAL-PCDC-009](./spec.md) | PCDC-001..004 | [PCDC-001..004](./plan.md) will record one commit per logical unit     |
