...
| --- | --- | --- |
| [VAL-WERG-001](./spec.md#success-criteria--verification-plan) | WERG-001 | [Complete four-state admission matrix and review](./tasks/tsk-0002-werg-001.md) |
...
| [VAL-WERG-001](./spec.md#success-criteria--verification-plan) | Completed | The exact 33-row four-state matrix and eight-row admitted set pass the task-local completeness and uniqueness probe plus independent full-pack content and checker-quality review.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
