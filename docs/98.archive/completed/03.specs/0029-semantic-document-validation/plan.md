...
- **Parent Spec**: `docs/03.specs/0029-semantic-document-validation/spec.md`
- **Parent Plan**: `docs/03.specs/0029-semantic-document-validation/plan.md`
...
| `docs/03.specs/0029-semantic-document-validation/plan.md` | `docs/03.specs/*.md` | first Markdown table after `## Item Index`; href `./<filename>.md` | same mapping | `README.md` |
| `docs/03.specs/0029-semantic-document-validation/README.md#task-records` | `docs/03.specs/*.md` | H3 anchor with code points `U+BB38 U+C11C U+0020 U+C778 U+B371 U+C2A4`; href `./<filename>.md` | same mapping | `README.md` |
...
- Modify: `docs/03.specs/0029-semantic-document-validation/spec.md`
- Modify: `docs/03.specs/README.md`
- Modify: `docs/03.specs/0029-semantic-document-validation/plan.md`
- Modify: `docs/03.specs/0029-semantic-document-validation/plan.md`
- Create: `docs/03.specs/0029-semantic-document-validation/README.md#task-records`
- Modify: `docs/03.specs/0029-semantic-document-validation/README.md#task-records`
...
spec = Path('docs/03.specs/0029-semantic-document-validation/spec.md')
plan = Path('docs/03.specs/0029-semantic-document-validation/plan.md')
task = Path('docs/03.specs/0029-semantic-document-validation/README.md#task-records')
task_table_anchor = '### ' + ''.join(map(chr, (0xBB38, 0xC11C, 0x20, 0xC778, 0xB371, 0xC2A4)))
indexes = {
    Path('docs/03.specs/README.md'): {
        'tree_h2': '## Document Index',
        'tree_line': '├── 0029-semantic-document-validation/',
        'table_kind': 'after-anchor',
        'table_anchor': '### Current Spec Index',
        'href': './0029-semantic-document-validation/spec.md',
    },
    Path('docs/03.specs/0029-semantic-document-validation/plan.md'): {
        'tree_h2': '## Item Index',
    ...
    Path('docs/03.specs/0029-semantic-document-validation/README.md#task-records'): {
        'tree_h2': '## Item Index',
        'tree_line': '├── 2026-07-12-semantic-document-validation.md',
        'table_kind': 'after-anchor',
...
expected = {
    ...
    plan: {
        '../../03.specs/0029-semantic-document-validation/spec.md',
...
for index, contract in indexes.items():
    ...
    assert f'](../../../../04.execution/plans/{contract["href"]})' not in outside_table, (index, 'href-outside-table')
PY
```
...
```bash
git add docs/03.specs/0029-semantic-document-validation/spec.md docs/03.specs/README.md \
  docs/03.specs/0029-semantic-document-validation/plan.md docs/03.specs/0029-semantic-document-validation/plan.md \
  docs/03.specs/0029-semantic-document-validation/README.md#task-records docs/03.specs/0029-semantic-document-validation/README.md#task-records \
...
pre-commit run --files \
  ...
  docs/03.specs/0029-semantic-document-validation/plan.md \
  docs/03.specs/0029-semantic-document-validation/README.md#task-records \
  docs/03.specs/0029-semantic-document-validation/README.md#task-records \
  docs/00.agent-governance/memory/progress.md
...
index_path = pathlib.Path('docs/03.specs/0029-semantic-document-validation/plan.md')
text = index_path.read_text()
targets = {
    pathlib.PurePosixPath(path).name
    for path in subprocess.check_output(
        ['git', 'ls-files', 'docs/03.specs/plans'], text=True
    ).splitlines()
...
git add scripts/validate-repo-quality-gates.sh scripts/validate-links-and-owners.py scripts/README.md tests/README.md \
  docs/03.specs/0029-semantic-document-validation/spec.md docs/03.specs/README.md \
  docs/03.specs/0029-semantic-document-validation/plan.md docs/03.specs/0029-semantic-document-validation/plan.md \
  docs/03.specs/0029-semantic-document-validation/README.md#task-records docs/03.specs/0029-semantic-document-validation/README.md#task-records \
  docs/00.agent-governance/memory/progress.md
...
- **Spec**: [Semantic Document Validation Technical Specification](./spec.md)
- **Plan**: [Semantic Document Validation Implementation Plan](./plan.md)
