...
owner: platform
updated: 2026-07-14
artifact_id: "SPEC-0025-PLAN-0001"
---
...
assert '../../03.specs/0025-governance-owner-and-roster-currentness/spec.md' in plan.read_text()
assert '../tasks/2026-07-11-governance-owner-and-roster-currentness.md' in plan.read_text()
assert '../../03.specs/0025-governance-owner-and-roster-currentness/spec.md' in task.read_text()
...
- Modify: `docs/03.specs/0006-workspace-harness-gap-analysis/spec.md`
- Modify: every `spec.md` under `docs/03.specs/009-*` through
  `docs/03.specs/024-*`
- Modify: `docs/03.specs/0024-observability-and-network-review-agents/agent-design.md`
- Modify: `docs/03.specs/README.md`
...
agent_design = Path('docs/03.specs/0024-observability-and-network-review-agents/agent-design.md').read_text()
...
```text
2026-07-06-sdlc-lifecycle-contract.md -> ../../03.specs/0021-sdlc-lifecycle-contract/spec.md
2026-07-07-workspace-engineering-research-pack-refresh.md -> ../../03.specs/0017-workspace-engineering-research-pack/spec.md
```
...
- **Archive Index**: [../../98.archive/README.md](../../../README.md)
