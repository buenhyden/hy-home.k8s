...
- **In scope**: Registry schema and lineage data, PRD-0005 and PRD-0006 program
  relations, current audit remediation overlay, Stage 00 lifecycle summaries,
  validator fixtures, and reciprocal program links.
- **Historical boundary**: ADR-0016, PRD-0005, AD-0008, completed Specs, Plans,
...
- Spec 033 is a historical follow-up to the PRD-0005 program; Specs 026-032
  ...
  the completed Spec.
- Specs 034-040 are the original tranche set for PRD-0006 and AD-0009.
...
- **VAL-ALF-001**: Specs 026-032 are the only original PRD-0005 tranches.
...
- **VAL-ALF-003**: Specs 034-040 form the ordered PRD-0006 tranche set.
...
- Registry v6 declares two typed programs, keeps Specs 034-040 in PRD-0006
