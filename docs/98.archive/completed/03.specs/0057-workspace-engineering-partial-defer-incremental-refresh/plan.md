...
- The existing `docs/90.references/research/0001-workspace-engineering/` directory is the
...
| --- | --- | --- |
| `006` Common system | `m0001-workspace-governance-and-common-agent-environment.md` | Shared static controls versus provider-native/effective parity |
| `008` Kubernetes | `m0007-kubernetes-infrastructure-and-security.md` | Public security/controller semantics versus cluster evidence |
| `009` Infrastructure | `m0007-kubernetes-infrastructure-and-security.md` | GitOps/gateway/registry/cloud contracts versus live state |
| `014` Guide | `m0004-spec-driven-sdlc-and-document-contracts.md` | Taxonomy/usability basis versus local enum implementation |
| `020` Diátaxis | `m0005-documentation-architecture-and-diataxis.md` | Current official framework/source versus approved local decisions |
| `022` CI/CD | `m0008-ci-cd-github-actions-and-qa.md` | Delivery/promotion/rollback metadata versus execution evidence |
| `023` GitHub Actions | `m0008-ci-cd-github-actions-and-qa.md` | Hosted run, ruleset, permission, environment, OIDC, artifact metadata |
| `025` Security | `m0007-kubernetes-infrastructure-and-security.md` | Public controls/static shapes versus effective enforcement |
| `026` AI-agent systems | `m0009-ai-agents-and-agency-agents.md` | Current product contracts versus runtime effectiveness |
| `028` Model routing | `m0010-agent-model-routing-and-configuration.md` | Provider config/routing rules versus runtime fitness/promotion |
| `032` Memory management | `m0011-agent-memory-tiers-and-management.md` | Provider/MCP lifecycle rules versus effective persistence |
| `033` Verification/Validation | `m0008-ci-cd-github-actions-and-qa.md` | Public responsibility/evidence semantics versus stakeholder/live proof |

### Shared owners and evidence hierarchy

- Source and claim records live in
  `m0012-source-coverage.md`. Workstreams emit reviewed
  non-secret proposals without final IDs; PDRR-006 allocates contiguous IDs and
  commits those rows with README and `m0013-scope-application-index.md` after all
  workstreams.
...
human-approved [Spec 0057](./spec.md)
and its reciprocal
...
- [x] **Step 1: Create the Task from the current template.** Use
  `docs/99.templates/templates/specs/task.template.md`. Remove every
...
- [x] **Step 3: Freeze the baseline ledger through the checker.** Run:
  ...
  ```bash
  python3 /tmp/pdrr-refresh-check.py snapshot-ledger --source docs/90.references/research/0001-workspace-engineering/m0012-source-coverage.md --output /tmp/pdrr-ledger-before.md
...
`m0001-workspace-governance-and-common-agent-environment.md`, conditional
`m0003-provider-implementation-status.md`, `m0009-ai-agents-and-agency-agents.md`,
`m0010-agent-model-routing-and-configuration.md`,
`m0011-agent-memory-tiers-and-management.md`; temporary
...
**Files:** `m0007-kubernetes-infrastructure-and-security.md`; temporary
...
**Files:** `m0004-spec-driven-sdlc-and-document-contracts.md`,
`m0005-documentation-architecture-and-diataxis.md`, temporary
...
`/tmp/pdrr-ci-proposals.json`; `m0008-ci-cd-github-actions-and-qa.md`;
Task/Plan/progress.
...
**Files:** pack `README.md`, `m0013-scope-application-index.md`, source/claim ledger;
