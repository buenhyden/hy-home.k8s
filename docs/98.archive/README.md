...
> 현재 구현과 상충되는 old `docs/01-04` 문서의 Tombstone을 보관하는 중앙 archive stage다.
...
- `docs/01.requirements`, `docs/02.architecture`, `docs/03.specs`, `docs/04.execution`에서 제거된 old 문서 Tombstone
...
- active stage는 `../01.requirements/`, `../02.architecture/`, `../03.specs/`, `../04.execution/`로 연결한다.
