---
title: "Direct-Approval Standalone Execution Lineage"
version: "1.0.0"
...
| --- | --- | --- |
| Direct human approval recorded in the Spec body | N/A — first typed standalone-execution relation; preserves ADR-0016/0017 program lineage semantics | [Spec 053](../../../completed/03.specs/0053-workspace-engineering-research-pack-consolidation/spec.md) |
...
| Direct human approval recorded in the Spec body | N/A — eleventh typed standalone-execution relation; reuses the same closed approval and ownership semantics | [Spec 0063](../../../completed/03.specs/0063-governance-invariant-consolidation/spec.md) |
| Direct human approval recorded in the Spec body | N/A — twelfth typed standalone-execution relation; reuses the same closed approval and ownership semantics | [Spec 0064](../../../completed/03.specs/0064-agent-governance-surface-consolidation/spec.md) |
| Direct human approval recorded in the Spec body | N/A — thirteenth typed standalone-execution relation; reuses the same closed approval and ownership semantics | [Spec 0065](../../../completed/03.specs/0065-transition-residue-retirement/spec.md) |
| [ADR-0031](../../../../02.architecture/decisions/0031-current-corpus-retention-and-validation-ownership.md) | Supersedes permanent standalone instance-roster authority with package-local execution ownership; preserves direct human approval as historical context. | [Spec 0054](../../../../03.specs/0054-sdlc-document-and-agent-governance-consolidation/spec.md) |
