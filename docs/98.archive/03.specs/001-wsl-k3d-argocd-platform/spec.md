---
title: 'Archive Tombstone: WSL k3d/k3s ArgoCD Platform Technical Specification'
...
# Archive Tombstone: WSL k3d/k3s ArgoCD Platform Technical Specification
...
- Original path: `docs/03.specs/001-wsl-k3d-argocd-platform/spec.md`
- Original title: WSL k3d/k3s ArgoCD Platform Technical Specification
- Original type: spec

## Archive Decision

- Archived on: 2026-06-02
- Reason: Old baseline spec replaced by the current local GitOps platform spec.
