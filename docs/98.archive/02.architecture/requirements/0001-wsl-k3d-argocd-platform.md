---
title: 'Archive Tombstone: WSL k3d/k3s ArgoCD Platform Architecture Reference Document'
...
# Archive Tombstone: WSL k3d/k3s ArgoCD Platform Architecture Reference Document
...
- Original path: `docs/02.architecture/requirements/0001-wsl-k3d-argocd-platform.md`
- Original title: WSL k3d/k3s ArgoCD Platform Architecture Reference Document
- Original type: ard

## Archive Decision

- Archived on: 2026-06-02
- Reason: Old architecture baseline replaced by the current local GitOps platform ARD.
