---
title: 'Archive Tombstone: ADR-0007: Kubernetes Dashboard v3 Installation'
...
- Original path: `docs/02.architecture/decisions/0007-kubernetes-dashboard-v3.md`
- Original title: ADR-0007: Kubernetes Dashboard v3 Installation
- Original type: adr

## Archive Decision

- Archived on: 2026-06-02
- Reason: Removed cluster UI decision; current UI contract is consolidated in ADR-0014.
