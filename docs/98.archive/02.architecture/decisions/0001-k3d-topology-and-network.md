---
title: 'Archive Tombstone: ADR-0001: k3d Topology and External Network Baseline'
type: content/archive-tombstone
status: archived
owner: platform
updated: 2026-06-02
original_path: docs/02.architecture/decisions/0001-k3d-topology-and-network.md
archived_on: 2026-06-02
archive_reason: superseded
replacement: docs/02.architecture/decisions/0014-current-local-gitops-platform-contract.md
---

# Archive Tombstone: ADR-0001: k3d Topology and External Network Baseline
...
- Original path: `docs/02.architecture/decisions/0001-k3d-topology-and-network.md`
- Original title: ADR-0001: k3d Topology and External Network Baseline
- Original type: adr

## Archive Decision

- Archived on: 2026-06-02
- Reason: Old topology decision contained non-current endpoint assumptions; current topology contract is consolidated in ADR-0014.
