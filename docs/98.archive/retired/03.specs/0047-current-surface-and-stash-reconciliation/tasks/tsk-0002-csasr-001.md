...
| --- | --- | --- | --- | --- | --- | --- |
| CSASR-001 | VAL-CSASR-001, VAL-CSASR-002, VAL-CSASR-006 | Inventory every tracked target and resolve one surface/owner | platform | Cancelled | Not executed | Exact `git ls-files` population and affected-surface classification |
...
| --- | --- | --- |
| N/A — legacy work item `CSASR-001` | Cancelled (2026-09-24): the owning Spec is withdrawn. | Row-specific result and evidence remain in the Task Table above. |
