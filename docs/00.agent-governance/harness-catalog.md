...
| Drift garbage collection                    | `rules/agentic.md`, `documentation-protocol.md`, `scripts/validate-repo-quality-gates.sh`, `docs/98.archive`, `memory/progress.md`                     | Ready  | None | Treat recurring code, document, and structure drift as harness defects; clean temporary/debug artifacts, preserve conflicting old docs as governed Archive Records, and add deterministic validator coverage when possible.                                                                                                                                                                                                            |
