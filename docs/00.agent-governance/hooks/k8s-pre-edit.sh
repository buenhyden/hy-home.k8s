...
def authored_doc_template(path: str) -> str:
    ...
    if re.match(r"^docs/(01\.requirements|02\.architecture|03\.specs|04\.execution|05\.operations|90\.references|98\.archive)(/|$)", path):
        if path.endswith("/README.md"):
            return "classify via docs/99.templates/support/document-profiles.json and docs/99.templates/support/document-contract.md before writing"
        ...
        if path.startswith("docs/03.specs/"):
            spec_templates = {
                ...
                "plan.md": "docs/99.templates/templates/sdlc/execution/plan.template.md",
                "tasks.md": "docs/99.templates/templates/sdlc/execution/task.template.md",
            }
            return spec_templates.get(basename, "classify via docs/99.templates/support/document-contract.md before writing")
        ...
        if incident_match:
            ...
            return "classify via docs/99.templates/support/document-contract.md; incident filename must match the incident folder"
        ...
        return "classify via docs/99.templates/support/document-contract.md before writing"
    return ""
            ...
            messages.append(
                "\n".join(
                    [
                        ...
                        "- Template-First is mandatory: confirm the route in `docs/99.templates/support/document-contract.md`; use `docs/99.templates/README.md` as the inventory summary.",
                        route_line,
