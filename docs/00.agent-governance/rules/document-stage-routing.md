...
| Task record | `docs/04.execution/tasks/` | [Template Routing Contract](../../99.templates/support/template-routing.md) | Use for implementation status, validation evidence, and handoff; apply the [canonical Task Approval and Safety Boundaries](../../99.templates/templates/sdlc/execution/task.template.md#approval-and-safety-boundaries) for protected surfaces. |
