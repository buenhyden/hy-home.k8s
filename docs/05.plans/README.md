...
| [`2026-03-28-wsl2-k3d-argocd-ha-platform.md`](./2026-03-28-wsl2-k3d-argocd-ha-platform.md) | EndpointSlice 전환 + TLS(Traefik 443) + 최소권한/검증 자동화 포함 실행 계획 | Draft | 2026-03-28 |
