...
| PLN-016 | Traefik router config 명세 생성 (외부 repo용)            | `docs/04.specs/003-platform-expansion/spec.md` 참조                                    | REQ-FUN-11    | 별도 repo 적용 후 HTTPS 접근   |
| PLN-017 | 문서 체인 갱신 (ADR-0001/0004/0005 IP 수정)              | `docs/03.adr/0001,0004,0005-*.md`                                                      | 추적성        | 링크 정합성 확인               |
