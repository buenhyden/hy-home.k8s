...
| PLN-012 | follow-up evidence를 local/CI-only/skipped로 분리해 기록 | `docs/05.plans/`, `docs/06.tasks/` | REQ-EVIDENCE-001 | verification summary distinguishes local PASS from optional unavailable tooling |
