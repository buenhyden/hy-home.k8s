...
| --- | --- | --- | --- | --- |
| PLN-001 | 버전 freeze 및 환경 가정 검증 | `docs/06.tasks/...` | REQ-PRD-FUN-01 | VAL-PLN-001 |
| PLN-002 | k3d 클러스터 및 ingress 설계 확정 | `docs/04.specs/...` | REQ-PRD-FUN-01/02 | VAL-PLN-002 |
| PLN-003 | ArgoCD Helm + App-of-Apps 설계 확정 | `docs/03.adr/0002...` | REQ-PRD-FUN-03/04 | VAL-PLN-003 |
| PLN-004 | ESO+Vault 및 외부 endpoint 계약 확정 | `docs/03.adr/0003...`, `0004...` | REQ-PRD-FUN-05/06/07 | VAL-PLN-004 |
