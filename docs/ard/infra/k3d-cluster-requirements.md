...
- **CI/CD Pipeline**: Out of scope for base cluster bootstrap (v1). GitOps is implemented as a separate feature using ArgoCD + Sealed Secrets; see [GitOps ARD](../../../docs/ard/gitops/argocd-gitops-architecture.md).
