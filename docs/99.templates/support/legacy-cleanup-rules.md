...
| GitHub-native Markdown frontmatter | Frontmatter-free `.github` control body with canonical links | Reject on `.github/README.md`, `.github/PULL_REQUEST_TEMPLATE.md`, and `.github/SECURITY.md` |
