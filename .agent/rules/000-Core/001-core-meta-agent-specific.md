...
## 7. Craftsmanship Standards (Ultra-Lean)

- **Zero Noise**: Avoid introductory fluff.
- **Pedagogical Snippets**: Use code blocks to demonstrate syntax.
- **Prohibited Behaviors**: Explicitly list actions the agent is forbidden from taking.
- **Mandatory Protocols**: Use clear, imperative language ("MUST", "BLOCKED").


## See Also

- [000-core-general.md](./000-core-general.md) - Core coding standards
- [019-core-documentation-standards.md](./019-core-documentation-standards.md) - Documentation format
