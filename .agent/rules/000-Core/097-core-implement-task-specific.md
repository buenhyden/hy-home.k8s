...
- [040-core-code-generation-specific.md](./040-core-code-generation-specific.md) - Code generation quality
- [050-core-debugging-specific.md](./050-core-debugging-specific.md) - Testing and debugging
