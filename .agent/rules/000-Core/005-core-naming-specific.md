...
- **No Magic**: Avoid magic numbers/strings in code. Use specialized constants over literals.
  - **Bad**: `if (status == 5) ...`
  - **Good**: `const MAX_RETRIES = 5; if (status == MAX_RETRIES) ...`

## See Also

- [000-core-general.md](./000-core-general.md) - Core coding principles
- [040-core-code-generation-specific.md](./040-core-code-generation-specific.md) - Code generation that uses naming conventions
