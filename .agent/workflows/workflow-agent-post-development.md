...
1. **Spec Alignment**: Compare the PR diff against the originating `docs/specs/YYYY-MM-DD-<feature-name>.md`. Find any code that implements undocumented logic.
...
3. **Template Enforcement**: You MUST use `templates/operations/runbook-template.md` (save to `docs/runbooks/`).
4. **Location Rule**: Save it to `docs/runbooks/[service]-runbook.md`.
