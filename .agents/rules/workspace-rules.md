...
- All architecture, requirement, spec, and operations documents must follow the
  profile route in `docs/99.templates/registry.json` and start from its terminal
  template under `docs/99.templates/templates/`.
...
- **Routing**: use `docs/00.agent-governance/rules/document-authoring.md`
  for stage selection, `docs/99.templates/registry.json` for the exact
  profile/target/template map, and `docs/99.templates/README.md` for author guidance.
