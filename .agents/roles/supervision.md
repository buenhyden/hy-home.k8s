...
common governance owns human policy; the neutral registry owns the roster and handoffs; provider projections own native configuration. Shared CI surfaces split policy/permissions from validation-lane implementation.
