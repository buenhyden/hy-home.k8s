...
require_pattern 'https://kubernetes\.github\.io/dashboard' "$APPPROJECT_PLATFORM"
require_pattern 'https://istio-release\.storage\.googleapis\.com/charts' "$APPPROJECT_PLATFORM"
require_pattern 'https://kiali\.io/helm-charts' "$APPPROJECT_PLATFORM"
...
require_pattern '172\.19\.0\.20/32' "$KIALI_NP"
require_pattern '172\.19\.0\.24/32' "$KIALI_NP"
require_pattern '172\.19\.0\.22/32' "$KIALI_NP"
